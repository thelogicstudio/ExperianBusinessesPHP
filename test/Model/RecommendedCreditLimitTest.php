...
/**
 * RecommendedCreditLimitTest Class Doc Comment
 *
 * @category    Class
 * @description Experian recommended credit limit amount that is based on trade information, industry, age of the business and the commercial score
 * @package     TheLogicStudio\ExperianBusinessesPHP
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RecommendedCreditLimitTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "RecommendedCreditLimit"
     */
    public function testRecommendedCreditLimit()
    {
    }
}
