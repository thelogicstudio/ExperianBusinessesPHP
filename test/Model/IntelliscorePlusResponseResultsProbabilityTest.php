<?php
/**
 * IntelliscorePlusResponseResultsProbabilityTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * IntelliscorePlusResponseResultsProbabilityTest Class Doc Comment
 *
 * @category    Class
 * @description Probability percentage that the business will go bad
 * @package     TheLogicStudio\ExperianBusinessesPHP
 * @author      Swagger Codegen team
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsProbabilityTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * Test "IntelliscorePlusResponseResultsProbability"
     */
    public function testIntelliscorePlusResponseResultsProbability()
    {
    }
