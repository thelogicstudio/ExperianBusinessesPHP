...
/**
 * ContactsBusinessAffiliationsResult Class Doc Comment
 *
 * @category Class
 * @description Indicates any business affiliations of the contacts at the business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactsBusinessAffiliationsResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactsBusinessAffiliationsResult';
    ...
    protected static $swaggerTypes = [
        ...
        'cid' => 'string',
        'title' => 'string',
        'contact_activity_indicator' => 'bool',
    ...
    protected static $swaggerFormats = [
        ...
        'cid' => null,
        'title' => null,
        'contact_activity_indicator' => null,
        'contact_supplier' => null,
        'first_name' => null,
        'middle_name' => null,
        'last_name' => null,
        'bin' => null,
    ...
    protected static $attributeMap = [
        ...
        'cid' => 'cid',
        'title' => 'title',
        'contact_activity_indicator' => 'contactActivityIndicator',
    ...
    protected static $setters = [
        ...
        'cid' => 'setCid',
        'title' => 'setTitle',
        'contact_activity_indicator' => 'setContactActivityIndicator',
        'contact_supplier' => 'setContactSupplier',
    ...
    protected static $getters = [
        ...
        'cid' => 'getCid',
        'title' => 'getTitle',
        'contact_activity_indicator' => 'getContactActivityIndicator',
        'contact_supplier' => 'getContactSupplier',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contact_activity_indicator'] = isset($data['contact_activity_indicator']) ? $data['contact_activity_indicator'] : null;
        $this->container['contact_supplier'] = isset($data['contact_supplier']) ? $data['contact_supplier'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['cid']) && (mb_strlen($this->container['cid']) > 11)) {
            $invalidProperties[] = "invalid value for 'cid', the character length must be smaller than or equal to 11.";
        }
        ...
        if (!is_null($this->container['contact_supplier']) && (mb_strlen($this->container['contact_supplier']) > 40)) {
            $invalidProperties[] = "invalid value for 'contact_supplier', the character length must be smaller than or equal to 40.";
        }
        ...
        if (!is_null($this->container['middle_name']) && (mb_strlen($this->container['middle_name']) > 32)) {
            $invalidProperties[] = "invalid value for 'middle_name', the character length must be smaller than or equal to 32.";
        }
        ...
        if (!is_null($this->container['business_name']) && (mb_strlen($this->container['business_name']) > 120)) {
            $invalidProperties[] = "invalid value for 'business_name', the character length must be smaller than or equal to 120.";
        }
     ...
     *
     * @param float $sequence_number Sequence number for ordering
     *
     * @return $this
     */
     ...
     * Sets cid
     *
     * @param string $cid Experian's unique identifier for the business contact
     *
     * @return $this
     */
    public function setCid($cid)
    {
        if (!is_null($cid) && (mb_strlen($cid) > 11)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 11.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 60.');
        }
    ...
    /**
     * Gets contact_activity_indicator
     *
     * @return bool
     */
    public function getContactActivityIndicator()
    {
        return $this->container['contact_activity_indicator'];
    }

    /**
     * Sets contact_activity_indicator
     *
     * @param bool $contact_activity_indicator If true indicates that the contact is likely active with the business
     *
     * @return $this
     */
    public function setContactActivityIndicator($contact_activity_indicator)
    {
        $this->container['contact_activity_indicator'] = $contact_activity_indicator;

        return $this;
    }

    /**
     * Gets contact_supplier
     *
     * @return string
     */
    public function getContactSupplier()
    {
        return $this->container['contact_supplier'];
    }

    /**
     * Sets contact_supplier
     *
     * @param string $contact_supplier Indicates the supplier of the contact, if available to be presented
     *
     * @return $this
     */
    public function setContactSupplier($contact_supplier)
    {
        if (!is_null($contact_supplier) && (mb_strlen($contact_supplier) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_supplier when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 40.');
        }

        $this->container['contact_supplier'] = $contact_supplier;
    ...
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 32.');
        }
     ...
     * Sets middle_name
     *
     * @param string $middle_name Contact Middle name
     *
     * @return $this
     */
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 32.');
        }
    ...
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 32.');
        }
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 9.');
        }
    ...
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling ContactsBusinessAffiliationsResult., must be smaller than or equal to 120.');
        }
