...
/**
 * CollectionAgencyInfoResult Class Doc Comment
 *
 * @category Class
 * @description Information on the collection agency that reported the collection account
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CollectionAgencyInfoResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CollectionAgencyInfoResult';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['phone_number']) && (mb_strlen($this->container['phone_number']) > 10)) {
            $invalidProperties[] = "invalid value for 'phone_number', the character length must be smaller than or equal to 10.";
        }
     ...
     * Sets name
     *
     * @param string $name Name of the collection agency where the account was placed
     *
     * @return $this
     */
    public function setName($name)
    {
        if (!is_null($name) && (mb_strlen($name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $name when calling CollectionAgencyInfoResult., must be smaller than or equal to 35.');
        }
     ...
     * Sets phone_number
     *
     * @param string $phone_number Collection agency phone number. Format = +15555555555
     *
     * @return $this
     */
    public function setPhoneNumber($phone_number)
    {
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling CollectionAgencyInfoResult., must be smaller than or equal to 10.');
        }
