...
/**
 * AmountModifier Class Doc Comment
 *
 * @category Class
 * @description Amounts with or without modifiers
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AmountModifier implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AmountModifier';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['modifier']) && (mb_strlen($this->container['modifier']) > 40)) {
            $invalidProperties[] = "invalid value for 'modifier', the character length must be smaller than or equal to 40.";
        }
     ...
     * Sets amount
     *
     * @param float $amount amount reported
     *
     * @return $this
     */
    ...
    {
        if (!is_null($modifier) && (mb_strlen($modifier) > 40)) {
            throw new \InvalidArgumentException('invalid length for $modifier when calling AmountModifier., must be smaller than or equal to 40.');
        }
