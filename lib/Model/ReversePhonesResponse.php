...
/**
 * ReversePhonesResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReversePhonesResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReversePhonesResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'success' => 'bool',
        'comments' => 'string',
        'reverse_phones' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ReversePhones[]'
    ];
    ...
    protected static $setters = [
        ...
        'reverse_phones' => 'setReversePhones'
    ];
    ...
    protected static $getters = [
        ...
        'reverse_phones' => 'getReversePhones'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reverse_phones'] = isset($data['reverse_phones']) ? $data['reverse_phones'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['request_id']) && (mb_strlen($this->container['request_id']) > 50)) {
     ...
     * Sets request_id
     *
     * @param string $request_id Experian auto-generated ID for your request
     *
     * @return $this
     */
    public function setRequestId($request_id)
    {
        if (!is_null($request_id) && (mb_strlen($request_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $request_id when calling ReversePhonesResponse., must be smaller than or equal to 50.');
        }
     ...
     * Sets success
     *
     * @param bool $success If true indicates a success response status
     *
     * @return $this
     */
     ...
     * Sets comments
     *
     * @param string $comments A free form reference field to send a comment along with your request; the comment will be returned with your response. Useful for ID tracking.
     *
     * @return $this
     */
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 30)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling ReversePhonesResponse., must be smaller than or equal to 30.');
        }
     ...
     */
    public function getReversePhones()
    {
        return $this->container['reverse_phones'];
    }

    /**
     * Sets reverse_phones
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ReversePhones[] $reverse_phones Array containing businesses that match the phone input on the request
     *
     * @return $this
     */
    public function setReversePhones($reverse_phones)
    {
        $this->container['reverse_phones'] = $reverse_phones;
