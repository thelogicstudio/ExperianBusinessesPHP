...
/**
 * TradePaymentExperiencesResultAccountBalance Class Doc Comment
 *
 * @category Class
 * @description Account balance for all active accounts
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentExperiencesResultAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentExperiencesResult_accountBalance';
     ...
     * Sets amount
     *
     * @param float $amount Account balance
     *
     * @return $this
     */
