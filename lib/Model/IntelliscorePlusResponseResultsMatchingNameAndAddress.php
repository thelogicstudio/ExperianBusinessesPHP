...
/**
 * IntelliscorePlusResponseResultsMatchingNameAndAddress Class Doc Comment
 *
 * @category Class
 * @description Matching business name and address
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsMatchingNameAndAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_matchingNameAndAddress';
