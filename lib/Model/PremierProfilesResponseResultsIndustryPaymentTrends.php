...
/**
 * PremierProfilesResponseResultsIndustryPaymentTrends Class Doc Comment
 *
 * @category Class
 * @description Snapshot of key performance metrics and trade balances for the last 6 months; current and 6 previous
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PremierProfilesResponseResultsIndustryPaymentTrends implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PremierProfilesResponse_results_industryPaymentTrends';
    ...
    protected static $swaggerTypes = [
        'sic' => 'string',
        'trends' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[]'
    ];
     ...
     * Sets sic
     *
     * @param string $sic 3-digit SIC Code of the inquired upon business
     *
     * @return $this
     */
     ...
     * Sets trends
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[] $trends Snapshot of key performance metrics and trade balances
     *
     * @return $this
     */
