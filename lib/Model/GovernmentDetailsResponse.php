...
/**
 * GovernmentDetailsResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResponse extends BusinessDataResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResponse';
    ...
    protected static $swaggerTypes = [
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResult'
    ];
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResult $results results
     *
     * @return $this
     */
