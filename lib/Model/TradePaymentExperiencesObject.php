...
/**
 * TradePaymentExperiencesObject Class Doc Comment
 *
 * @category Class
 * @description Trade Payment Experiences
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentExperiencesObject implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentExperiencesObject';
    ...
    protected static $swaggerTypes = [
        'trade_new_and_continuous' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[]',
        'trade_additional' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[]'
    ];
    ...
    protected static $swaggerFormats = [
        'trade_new_and_continuous' => null,
        'trade_additional' => null
    ];
    ...
    protected static $attributeMap = [
        'trade_new_and_continuous' => 'tradeNewAndContinuous',
        'trade_additional' => 'tradeAdditional'
    ];
    ...
    protected static $setters = [
        'trade_new_and_continuous' => 'setTradeNewAndContinuous',
        'trade_additional' => 'setTradeAdditional'
    ];
    ...
    protected static $getters = [
        'trade_new_and_continuous' => 'getTradeNewAndContinuous',
        'trade_additional' => 'getTradeAdditional'
    ];
    ...
    {
        $this->container['trade_new_and_continuous'] = isset($data['trade_new_and_continuous']) ? $data['trade_new_and_continuous'] : null;
        $this->container['trade_additional'] = isset($data['trade_additional']) ? $data['trade_additional'] : null;
    }
    ...
    /**
     * Gets trade_new_and_continuous
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[]
     */
    public function getTradeNewAndContinuous()
    {
        return $this->container['trade_new_and_continuous'];
    }

    /**
     * Sets trade_new_and_continuous
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[] $trade_new_and_continuous Array containing new and continuous trade payment experiences
     *
     * @return $this
     */
    public function setTradeNewAndContinuous($trade_new_and_continuous)
    {
        $this->container['trade_new_and_continuous'] = $trade_new_and_continuous;

        return $this;
    }

    /**
     * Gets trade_additional
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[]
     */
    public function getTradeAdditional()
    {
        return $this->container['trade_additional'];
    }

    /**
     * Sets trade_additional
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentExperiences[] $trade_additional Array containing additional trade payment experiences
     *
     * @return $this
     */
    public function setTradeAdditional($trade_additional)
    {
        $this->container['trade_additional'] = $trade_additional;
