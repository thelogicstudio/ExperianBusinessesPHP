...
/**
 * ContactsAndTitlesResult Class Doc Comment
 *
 * @category Class
 * @description Contains a list of Business Contacts and their Titles, if available
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContactsAndTitlesResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ContactsAndTitlesResult';
    ...
    public function setCid($cid)
    {
        if (!is_null($cid) && (mb_strlen($cid) > 11)) {
            throw new \InvalidArgumentException('invalid length for $cid when calling ContactsAndTitlesResult., must be smaller than or equal to 11.');
        }
    ...
    public function setTitle($title)
    {
        if (!is_null($title) && (mb_strlen($title) > 60)) {
            throw new \InvalidArgumentException('invalid length for $title when calling ContactsAndTitlesResult., must be smaller than or equal to 60.');
        }
    ...
    public function setContactSupplier($contact_supplier)
    {
        if (!is_null($contact_supplier) && (mb_strlen($contact_supplier) > 40)) {
            throw new \InvalidArgumentException('invalid length for $contact_supplier when calling ContactsAndTitlesResult., must be smaller than or equal to 40.');
        }
     ...
     * Sets first_name
     *
     * @param string $first_name First name of the business contact
     *
     * @return $this
     */
    public function setFirstName($first_name)
    {
        if (!is_null($first_name) && (mb_strlen($first_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling ContactsAndTitlesResult., must be smaller than or equal to 32.');
        }
     ...
     * Sets middle_name
     *
     * @param string $middle_name Middle name of the business contact
     *
     * @return $this
     */
    public function setMiddleName($middle_name)
    {
        if (!is_null($middle_name) && (mb_strlen($middle_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $middle_name when calling ContactsAndTitlesResult., must be smaller than or equal to 32.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name Last name of the business contact
     *
     * @return $this
     */
    public function setLastName($last_name)
    {
        if (!is_null($last_name) && (mb_strlen($last_name) > 32)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling ContactsAndTitlesResult., must be smaller than or equal to 32.');
        }
