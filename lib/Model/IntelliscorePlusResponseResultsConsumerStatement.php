...
/**
 * IntelliscorePlusResponseResultsConsumerStatement Class Doc Comment
 *
 * @category Class
 * @description Array containing Consumer Statement information
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsConsumerStatement implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_consumerStatement';
    ...
    protected static $swaggerTypes = [
        'type' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ConsumerStatementType',
     ...
     * Gets type
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ConsumerStatementType
     */
     ...
     * Sets type
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ConsumerStatementType $type type
     *
     * @return $this
     */
     ...
     * Sets date_reported
     *
     * @param string $date_reported Date the statement was reported. Format = YYYY-MM-DD
     *
     * @return $this
     */
     ...
     * Sets text
     *
     * @param string $text Text of the consumer's statement
     *
     * @return $this
     */
