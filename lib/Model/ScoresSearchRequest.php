...
/**
 * ScoresSearchRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScoresSearchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoresSearchRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'comments' => 'string',
        'model_code' => 'string',
        'match_reliability_code' => 'int',
        'commercial_score' => 'bool',
        'fsr_score' => 'bool',
        'collection_score' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchRequestCollectionScore'
    ];
    ...
    protected static $attributeMap = [
        ...
        'match_reliability_code' => 'matchReliabilityCode',
    ...
    protected static $setters = [
        ...
        'match_reliability_code' => 'setMatchReliabilityCode',
        'commercial_score' => 'setCommercialScore',
        'fsr_score' => 'setFsrScore',
        'collection_score' => 'setCollectionScore'
    ];
    ...
    protected static $getters = [
        ...
        'match_reliability_code' => 'getMatchReliabilityCode',
        'commercial_score' => 'getCommercialScore',
        'fsr_score' => 'getFsrScore',
        'collection_score' => 'getCollectionScore'
    ];
    ...
    {
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'Experian';
        $this->container['city'] = isset($data['city']) ? $data['city'] : 'Costa Mesa';
        $this->container['state'] = isset($data['state']) ? $data['state'] : 'CA';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['street'] = isset($data['street']) ? $data['street'] : '475 ANTON BLVD';
        $this->container['zip'] = isset($data['zip']) ? $data['zip'] : '92626';
        $this->container['phone'] = isset($data['phone']) ? $data['phone'] : '9495673800';
        $this->container['tax_id'] = isset($data['tax_id']) ? $data['tax_id'] : '176970333';
        $this->container['geo'] = isset($data['geo']) ? $data['geo'] : true;
        $this->container['comments'] = isset($data['comments']) ? $data['comments'] : 'testing';
        $this->container['model_code'] = isset($data['model_code']) ? $data['model_code'] : '000254';
        $this->container['match_reliability_code'] = isset($data['match_reliability_code']) ? $data['match_reliability_code'] : 90;
        $this->container['commercial_score'] = isset($data['commercial_score']) ? $data['commercial_score'] : true;
        $this->container['fsr_score'] = isset($data['fsr_score']) ? $data['fsr_score'] : true;
        $this->container['collection_score'] = isset($data['collection_score']) ? $data['collection_score'] : null;
    }
     ...
     * Sets state
     *
     * @param string $state Business state code (e.g. CA)
     *
     * @return $this
     */
    public function setState($state)
    {
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ScoresSearchRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling ScoresSearchRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets street
     *
     * @param string $street Current street address of the business, include suite number if applicable
     *
     * @return $this
     */
     ...
     * Sets geo
     *
     * @param bool $geo If true, businessGeocode data will be returned. If geo is omitted or false, the response will not include geo data
     *
     * @return $this
     */
     ...
     * Sets model_code
     *
     * @param string $model_code Optional field used only when your subcode is configured for a custom or legacy risk model
     *
     * @return $this
     */
    ...
    /**
     * Gets match_reliability_code
     *
     * @return int
     */
    public function getMatchReliabilityCode()
    {
        return $this->container['match_reliability_code'];
    }

    /**
     * Sets match_reliability_code
     *
     * @param int $match_reliability_code Your desired Match Reliability Code threshold. The default is 96
     *
     * @return $this
     */
    public function setMatchReliabilityCode($match_reliability_code)
    {
        $this->container['match_reliability_code'] = $match_reliability_code;
     ...
     *
     * @param bool $commercial_score If true, receive the commercial score that has been configured for your subcode
     *
     * @return $this
     */
     ...
     * Sets fsr_score
     *
     * @param bool $fsr_score If true, receive the Financial Stability Risk score
     *
     * @return $this
     */
    ...
    /**
     * Gets collection_score
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchRequestCollectionScore
     */
    public function getCollectionScore()
    {
        return $this->container['collection_score'];
    }

    /**
     * Sets collection_score
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchRequestCollectionScore $collection_score collection_score
     *
     * @return $this
     */
    public function setCollectionScore($collection_score)
    {
        $this->container['collection_score'] = $collection_score;
