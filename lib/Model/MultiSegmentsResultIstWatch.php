...
/**
 * MultiSegmentsResultIstWatch Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiSegmentsResultIstWatch implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiSegmentsResult_istWatch';
    ...
    protected static $swaggerTypes = [
        'ofac_watchlist' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]',
        'dpv_watchlist' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]',
        'epls_watchlist' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]'
    ];
    ...
    protected static $attributeMap = [
        'ofac_watchlist' => 'ofacWatchlist',
        'dpv_watchlist' => 'dpvWatchlist',
        'epls_watchlist' => 'eplsWatchlist'
    ];
    ...
    protected static $setters = [
        'ofac_watchlist' => 'setOfacWatchlist',
        'dpv_watchlist' => 'setDpvWatchlist',
        'epls_watchlist' => 'setEplsWatchlist'
    ];
    ...
    protected static $getters = [
        'ofac_watchlist' => 'getOfacWatchlist',
        'dpv_watchlist' => 'getDpvWatchlist',
        'epls_watchlist' => 'getEplsWatchlist'
    ];
    ...
    {
        $this->container['ofac_watchlist'] = isset($data['ofac_watchlist']) ? $data['ofac_watchlist'] : null;
        $this->container['dpv_watchlist'] = isset($data['dpv_watchlist']) ? $data['dpv_watchlist'] : null;
        $this->container['epls_watchlist'] = isset($data['epls_watchlist']) ? $data['epls_watchlist'] : null;
    }
     ...
     * Gets ofac_watchlist
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]
     */
    public function getOfacWatchlist()
    {
        return $this->container['ofac_watchlist'];
    }

    /**
     * Sets ofac_watchlist
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[] $ofac_watchlist Array containing OFAC Watch list
     *
     * @return $this
     */
    public function setOfacWatchlist($ofac_watchlist)
    {
        $this->container['ofac_watchlist'] = $ofac_watchlist;
     ...
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]
     */
    public function getDpvWatchlist()
    {
        return $this->container['dpv_watchlist'];
    }

    /**
     * Sets dpv_watchlist
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[] $dpv_watchlist Array containing DPV Watch list
     *
     * @return $this
     */
    public function setDpvWatchlist($dpv_watchlist)
    {
        $this->container['dpv_watchlist'] = $dpv_watchlist;
     ...
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[]
     */
    public function getEplsWatchlist()
    {
        return $this->container['epls_watchlist'];
    }

    /**
     * Sets epls_watchlist
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ISTWatchlistResult[] $epls_watchlist Array containing EPLS Watch list
     *
     * @return $this
     */
    public function setEplsWatchlist($epls_watchlist)
    {
        $this->container['epls_watchlist'] = $epls_watchlist;
