...
/**
 * ScoresSearchResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScoresSearchResponse extends BusinessDataResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoresSearchResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'request_id' => 'string',
        'success' => 'bool',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchResponseResults'
    ];
     ...
     * Sets comments
     *
     * @param string $comments Comments with response
     *
     * @return $this
     */
     ...
     * Gets results
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchResponseResults
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ScoresSearchResponseResults $results results
     *
     * @return $this
     */
