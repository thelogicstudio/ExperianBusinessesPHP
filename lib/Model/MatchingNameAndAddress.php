...
/**
 * MatchingNameAndAddress Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MatchingNameAndAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MatchingNameAndAddress';
    ...
    public function setBusinessName($business_name)
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling MatchingNameAndAddress., must be smaller than or equal to 40.');
        }
