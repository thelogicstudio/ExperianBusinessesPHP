...
/**
 * BusinessUCCFilingsRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessUCCFilingsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessUCCFilingsRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'ucc_filings_summary' => 'bool',
        'ucc_filings_detail' => 'bool'
    ];
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '700969989';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['ucc_filings_summary'] = isset($data['ucc_filings_summary']) ? $data['ucc_filings_summary'] : true;
        $this->container['ucc_filings_detail'] = isset($data['ucc_filings_detail']) ? $data['ucc_filings_detail'] : true;
    }
     ...
     *
     * @param bool $ucc_filings_summary If true receive uccFilingsSummary
     *
     * @return $this
     */
     ...
     *
     * @param bool $ucc_filings_detail If true receive uccFilingsDetail
     *
     * @return $this
     */
