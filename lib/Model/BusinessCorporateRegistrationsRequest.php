...
/**
 * BusinessCorporateRegistrationsRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessCorporateRegistrationsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessCorporateRegistrationsRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'status_description_detail' => 'bool'
    ];
    ...
    protected static $swaggerFormats = [
        'bin' => null,
        'subcode' => null,
        'status_description_detail' => null
    ];
    ...
    protected static $attributeMap = [
        'bin' => 'bin',
        'subcode' => 'subcode',
        'status_description_detail' => 'statusDescriptionDetail'
    ];
    ...
    protected static $setters = [
        'bin' => 'setBin',
        'subcode' => 'setSubcode',
        'status_description_detail' => 'setStatusDescriptionDetail'
    ];
    ...
    protected static $getters = [
        'bin' => 'getBin',
        'subcode' => 'getSubcode',
        'status_description_detail' => 'getStatusDescriptionDetail'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['status_description_detail'] = isset($data['status_description_detail']) ? $data['status_description_detail'] : true;
    }
    ...
    /**
     * Gets status_description_detail
     *
     * @return bool
     */
    public function getStatusDescriptionDetail()
    {
        return $this->container['status_description_detail'];
    }

    /**
     * Sets status_description_detail
     *
     * @param bool $status_description_detail If true receive expanded detail on the corporate registration status, in non-standardized format
     *
     * @return $this
     */
    public function setStatusDescriptionDetail($status_description_detail)
    {
        $this->container['status_description_detail'] = $status_description_detail;
