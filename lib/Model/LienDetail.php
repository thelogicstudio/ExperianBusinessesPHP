...
/**
 * LienDetail Class Doc Comment
 *
 * @category Class
 * @description Array containing details of tax liens filed by the business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LienDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LienDetail';
    ...
    protected static $attributeMap = [
        ...
        'tax_lien_description' => 'taxLienDescription'
    ];
    ...
    protected static $setters = [
        ...
        'tax_lien_description' => 'setTaxLienDescription'
    ];
    ...
    protected static $getters = [
        ...
        'tax_lien_description' => 'getTaxLienDescription'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tax_lien_description'] = isset($data['tax_lien_description']) ? $data['tax_lien_description'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['legal_type']) && (mb_strlen($this->container['legal_type']) > 20)) {
            $invalidProperties[] = "invalid value for 'legal_type', the character length must be smaller than or equal to 20.";
        }

        if (!is_null($this->container['legal_action']) && (mb_strlen($this->container['legal_action']) > 10)) {
            $invalidProperties[] = "invalid value for 'legal_action', the character length must be smaller than or equal to 10.";
        }
        ...
        if (!is_null($this->container['filing_location']) && (mb_strlen($this->container['filing_location']) > 50)) {
            $invalidProperties[] = "invalid value for 'filing_location', the character length must be smaller than or equal to 50.";
        }

        if (!is_null($this->container['owner']) && (mb_strlen($this->container['owner']) > 40)) {
            $invalidProperties[] = "invalid value for 'owner', the character length must be smaller than or equal to 40.";
        }

        if (!is_null($this->container['tax_lien_description']) && (mb_strlen($this->container['tax_lien_description']) > 9)) {
            $invalidProperties[] = "invalid value for 'tax_lien_description', the character length must be smaller than or equal to 9.";
        }
     ...
     * Sets date_filed
     *
     * @param string $date_filed Date the lien was filed. ISO 8601 Format = YYYY-MM-DD
     *
     * @return $this
     */
    public function setDateFiled($date_filed)
    {
        if (!is_null($date_filed) && (mb_strlen($date_filed) > 10)) {
            throw new \InvalidArgumentException('invalid length for $date_filed when calling LienDetail., must be smaller than or equal to 10.');
        }
     ...
     * Sets legal_type
     *
     * @param string $legal_type \"Federal tax\", \"State tax\", or \"County tax\"
     *
     * @return $this
     */
    public function setLegalType($legal_type)
    {
        if (!is_null($legal_type) && (mb_strlen($legal_type) > 20)) {
            throw new \InvalidArgumentException('invalid length for $legal_type when calling LienDetail., must be smaller than or equal to 20.');
        }
     ...
     * Sets legal_action
     *
     * @param string $legal_action \"Filed\" or \"Released\"
     *
     * @return $this
     */
    public function setLegalAction($legal_action)
    {
        if (!is_null($legal_action) && (mb_strlen($legal_action) > 10)) {
            throw new \InvalidArgumentException('invalid length for $legal_action when calling LienDetail., must be smaller than or equal to 10.');
        }
    ...
    public function setDocumentNumber($document_number)
    {
        if (!is_null($document_number) && (mb_strlen($document_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $document_number when calling LienDetail., must be smaller than or equal to 16.');
        }
    ...
    {
        if (!is_null($filing_location) && (mb_strlen($filing_location) > 50)) {
            throw new \InvalidArgumentException('invalid length for $filing_location when calling LienDetail., must be smaller than or equal to 50.');
        }
    ...
    {
        if (!is_null($owner) && (mb_strlen($owner) > 40)) {
            throw new \InvalidArgumentException('invalid length for $owner when calling LienDetail., must be smaller than or equal to 40.');
        }
    ...
    /**
     * Gets tax_lien_description
     *
     * @return string
     */
    public function getTaxLienDescription()
    {
        return $this->container['tax_lien_description'];
    }

    /**
     * Sets tax_lien_description
     *
     * @param string $tax_lien_description tax Lien Description
     *
     * @return $this
     */
    public function setTaxLienDescription($tax_lien_description)
    {
        if (!is_null($tax_lien_description) && (mb_strlen($tax_lien_description) > 9)) {
            throw new \InvalidArgumentException('invalid length for $tax_lien_description when calling LienDetail., must be smaller than or equal to 9.');
        }

        $this->container['tax_lien_description'] = $tax_lien_description;
