...
/**
 * FsrScoreTrend Class Doc Comment
 *
 * @category Class
 * @description JSON object containing the four most recent quarters of FSR score information
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FsrScoreTrend implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FsrScoreTrend';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quarter']) && (mb_strlen($this->container['quarter']) > 7)) {
            $invalidProperties[] = "invalid value for 'quarter', the character length must be smaller than or equal to 7.";
        }
    ...
    {
        if (!is_null($quarter) && (mb_strlen($quarter) > 7)) {
            throw new \InvalidArgumentException('invalid length for $quarter when calling FsrScoreTrend., must be smaller than or equal to 7.');
        }
