...
/**
 * ExecutiveSummaryPaymentTrendIndicator Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryPaymentTrendIndicator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_paymentTrendIndicator';
     ...
     * Sets code
     *
     * @param string $code Payment trend indicator code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Payment trend indicator description
     *
     * @return $this
     */
