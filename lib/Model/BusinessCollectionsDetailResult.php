...
/**
 * BusinessCollectionsDetailResult Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessCollectionsDetailResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessCollectionsDetailResult';
    ...
    protected static $swaggerTypes = [
        ...
        'date_placed_for_collection' => 'string',
        'date_closed' => 'string',
        'amount_placed_for_collection' => 'float',
        'amount_paid' => 'float',
        'collection_agency_info' => '\TheLogicStudio\ExperianBusinessesPHP\Model\CollectionAgencyInfoResult'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'date_closed' => null,
        'amount_placed_for_collection' => null,
        'amount_paid' => null,
        'collection_agency_info' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'date_placed_for_collection' => 'datePlacedForCollection',
        'date_closed' => 'dateClosed',
        'amount_placed_for_collection' => 'amountPlacedForCollection',
        'amount_paid' => 'amountPaid',
        'collection_agency_info' => 'collectionAgencyInfo'
    ];
    ...
    protected static $setters = [
        ...
        'date_placed_for_collection' => 'setDatePlacedForCollection',
        'date_closed' => 'setDateClosed',
        'amount_placed_for_collection' => 'setAmountPlacedForCollection',
        'amount_paid' => 'setAmountPaid',
        'collection_agency_info' => 'setCollectionAgencyInfo'
    ];
    ...
    protected static $getters = [
        ...
        'date_placed_for_collection' => 'getDatePlacedForCollection',
        'date_closed' => 'getDateClosed',
        'amount_placed_for_collection' => 'getAmountPlacedForCollection',
        'amount_paid' => 'getAmountPaid',
        'collection_agency_info' => 'getCollectionAgencyInfo'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['date_placed_for_collection'] = isset($data['date_placed_for_collection']) ? $data['date_placed_for_collection'] : null;
        $this->container['date_closed'] = isset($data['date_closed']) ? $data['date_closed'] : null;
        $this->container['amount_placed_for_collection'] = isset($data['amount_placed_for_collection']) ? $data['amount_placed_for_collection'] : null;
        $this->container['amount_paid'] = isset($data['amount_paid']) ? $data['amount_paid'] : null;
        $this->container['collection_agency_info'] = isset($data['collection_agency_info']) ? $data['collection_agency_info'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['account_status']) && (mb_strlen($this->container['account_status']) > 2)) {
            $invalidProperties[] = "invalid value for 'account_status', the character length must be smaller than or equal to 2.";
        }

        if (!is_null($this->container['date_placed_for_collection']) && (mb_strlen($this->container['date_placed_for_collection']) > 8)) {
            $invalidProperties[] = "invalid value for 'date_placed_for_collection', the character length must be smaller than or equal to 8.";
        }

        if (!is_null($this->container['date_closed']) && (mb_strlen($this->container['date_closed']) > 8)) {
            $invalidProperties[] = "invalid value for 'date_closed', the character length must be smaller than or equal to 8.";
        }
     ...
     * Sets account_status
     *
     * @param string $account_status Open status includes \"Open Account\", \"Disputed\", or \"Payment Plan\". Closed status includes, but is not limited to, \"Paid in Full\", \"Settlement Paid in Full\", \"Partial Payment, Balance Uncollected\", \"Uncollected\", etc.
     *
     * @return $this
     */
    public function setAccountStatus($account_status)
    {
        if (!is_null($account_status) && (mb_strlen($account_status) > 2)) {
            throw new \InvalidArgumentException('invalid length for $account_status when calling BusinessCollectionsDetailResult., must be smaller than or equal to 2.');
        }
    ...
    /**
     * Gets date_placed_for_collection
     *
     * @return string
     */
    public function getDatePlacedForCollection()
    {
        return $this->container['date_placed_for_collection'];
    }

    /**
     * Sets date_placed_for_collection
     *
     * @param string $date_placed_for_collection Date the account was placed for collection. ISO 8601 Format = YYYY-MM-DD
     *
     * @return $this
     */
    public function setDatePlacedForCollection($date_placed_for_collection)
    {
        if (!is_null($date_placed_for_collection) && (mb_strlen($date_placed_for_collection) > 8)) {
            throw new \InvalidArgumentException('invalid length for $date_placed_for_collection when calling BusinessCollectionsDetailResult., must be smaller than or equal to 8.');
        }

        $this->container['date_placed_for_collection'] = $date_placed_for_collection;
     ...
     * Sets date_closed
     *
     * @param string $date_closed Date the account was closed. Format = YYYY-MM-DD. Null if not available
     *
     * @return $this
     */
    public function setDateClosed($date_closed)
    {
        if (!is_null($date_closed) && (mb_strlen($date_closed) > 8)) {
            throw new \InvalidArgumentException('invalid length for $date_closed when calling BusinessCollectionsDetailResult., must be smaller than or equal to 8.');
        }
    ...
    /**
     * Gets amount_placed_for_collection
     *
     * @return float
     */
    public function getAmountPlacedForCollection()
    {
        return $this->container['amount_placed_for_collection'];
    }

    /**
     * Sets amount_placed_for_collection
     *
     * @param float $amount_placed_for_collection The original amount that was placed for collection
     *
     * @return $this
     */
    public function setAmountPlacedForCollection($amount_placed_for_collection)
    {
        $this->container['amount_placed_for_collection'] = $amount_placed_for_collection;
     ...
     * Sets amount_paid
     *
     * @param float $amount_paid The amount that was paid of the total amount placed
     *
     * @return $this
     */
    ...
    /**
     * Gets collection_agency_info
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CollectionAgencyInfoResult
     */
    public function getCollectionAgencyInfo()
    {
        return $this->container['collection_agency_info'];
    }

    /**
     * Sets collection_agency_info
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CollectionAgencyInfoResult $collection_agency_info collection_agency_info
     *
     * @return $this
     */
    public function setCollectionAgencyInfo($collection_agency_info)
    {
        $this->container['collection_agency_info'] = $collection_agency_info;
