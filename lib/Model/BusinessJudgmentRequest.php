...
/**
 * BusinessJudgmentRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessJudgmentRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessJudgmentRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'judgment_summary' => 'bool',
        'judgment_detail' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['judgment_summary'] = isset($data['judgment_summary']) ? $data['judgment_summary'] : true;
        $this->container['judgment_detail'] = isset($data['judgment_detail']) ? $data['judgment_detail'] : true;
    }
     ...
     *
     * @param bool $judgment_summary If true receive summary information on judgments
     *
     * @return $this
     */
     ...
     *
     * @param bool $judgment_detail If true receive judgment details
     *
     * @return $this
     */
