...
/**
 * BusinessBankruptcyDataRequest Class Doc Comment
 *
 * @category Class
 * @description Business Bankruptcies Request
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessBankruptcyDataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessBankruptcyDataRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'bankruptcy_summary' => 'bool',
        'bankruptcy_detail' => 'bool'
    ];
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '404197602';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['bankruptcy_summary'] = isset($data['bankruptcy_summary']) ? $data['bankruptcy_summary'] : true;
        $this->container['bankruptcy_detail'] = isset($data['bankruptcy_detail']) ? $data['bankruptcy_detail'] : true;
    }
     ...
     *
     * @param bool $bankruptcy_summary If true receive a summary on any bankruptcy filings for the business
     *
     * @return $this
     */
     ...
     *
     * @param bool $bankruptcy_detail If true receive bankruptcy filing details for the business
     *
     * @return $this
     */
