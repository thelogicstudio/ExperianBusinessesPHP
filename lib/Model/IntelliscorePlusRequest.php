...
/**
 * IntelliscorePlusRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0517614';
        $this->container['model_code'] = isset($data['model_code']) ? $data['model_code'] : '000224';
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling IntelliscorePlusRequest., must be smaller than or equal to 2.');
        }
        if (!is_null($state) && (mb_strlen($state) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling IntelliscorePlusRequest., must be bigger than or equal to 2.');
        }
     ...
     * Sets model_code
     *
     * @param string $model_code Experian Risk Model Code. Default is \"000224\"
     *
     * @return $this
     */
