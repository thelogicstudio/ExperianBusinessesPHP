...
/**
 * ContractSpendingSummarySpendByFiscalYear Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContractSpendingSummarySpendByFiscalYear implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contractSpendingSummary_spendByFiscalYear';
     ...
     * Sets total_amount
     *
     * @param float $total_amount Total dollar amount
     *
     * @return $this
     */
     ...
     *
     * @param float $single_highest_amount Highest single transaction
     *
     * @return $this
     */
