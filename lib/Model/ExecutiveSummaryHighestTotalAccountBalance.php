...
/**
 * ExecutiveSummaryHighestTotalAccountBalance Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryHighestTotalAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_highestTotalAccountBalance';
     ...
     * Sets amount
     *
     * @param float $amount Highest total account balance
     *
     * @return $this
     */
