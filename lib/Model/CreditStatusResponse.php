...
/**
 * CreditStatusResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CreditStatusResponse extends BusinessDataResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CreditStatusResponse';
    ...
    protected static $swaggerTypes = [
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResultCreditStatus'
    ];
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResultCreditStatus $results results
     *
     * @return $this
     */
