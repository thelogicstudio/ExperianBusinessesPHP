...
/**
 * CorporateFinancialInformation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CorporateFinancialInformation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'corporateFinancialInformation';
    ...
    protected static $swaggerTypes = [
        ...
        'critical_data_and_financial_ratios' => '\TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationCriticalDataAndFinancialRatios[]'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'balance_sheets' => null,
        'operating_statements' => null,
        'critical_data_and_financial_ratios' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'operating_statements' => 'operatingStatements',
        'critical_data_and_financial_ratios' => 'criticalDataAndFinancialRatios'
    ];
    ...
    protected static $setters = [
        ...
        'balance_sheets' => 'setBalanceSheets',
        'operating_statements' => 'setOperatingStatements',
        'critical_data_and_financial_ratios' => 'setCriticalDataAndFinancialRatios'
    ];
    ...
    protected static $getters = [
        ...
        'balance_sheets' => 'getBalanceSheets',
        'operating_statements' => 'getOperatingStatements',
        'critical_data_and_financial_ratios' => 'getCriticalDataAndFinancialRatios'
    ];
    ...
    {
        $this->container['current_date'] = isset($data['current_date']) ? $data['current_date'] : null;
        $this->container['fiscal_year_end_date'] = isset($data['fiscal_year_end_date']) ? $data['fiscal_year_end_date'] : null;
        $this->container['balance_sheets'] = isset($data['balance_sheets']) ? $data['balance_sheets'] : null;
        $this->container['operating_statements'] = isset($data['operating_statements']) ? $data['operating_statements'] : null;
        $this->container['critical_data_and_financial_ratios'] = isset($data['critical_data_and_financial_ratios']) ? $data['critical_data_and_financial_ratios'] : null;
    }
    ...
    {
        return $this->container['current_date'];
    }

    /**
     * Sets current_date
     *
     * @param string $current_date Date the financial statement data is current through. Format = YYYY-MM-DD
     *
     * @return $this
     */
    public function setCurrentDate($current_date)
    {
        $this->container['current_date'] = $current_date;
     ...
     *
     * @param string $fiscal_year_end_date Date the financial statement data is current through. Format = YYYY-MM-DD
     *
     * @return $this
     */
     ...
     * Gets balance_sheets
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationBalanceSheets[]
     */
    public function getBalanceSheets()
    {
        return $this->container['balance_sheets'];
    }

    /**
     * Sets balance_sheets
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationBalanceSheets[] $balance_sheets A balance sheet is a company's statement of assets, liabilities and net worth. Information is included for up to three fiscal years. You can analyze the current statement or conduct up to a three-year trend analysis of key financial items
     *
     * @return $this
     */
    public function setBalanceSheets($balance_sheets)
    {
        $this->container['balance_sheets'] = $balance_sheets;

        return $this;
    }

    /**
     * Gets operating_statements
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationOperatingStatements[]
     */
    public function getOperatingStatements()
    {
        return $this->container['operating_statements'];
    }

    /**
     * Sets operating_statements
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationOperatingStatements[] $operating_statements Operating statement, also known as a profit and loss statement or income statement, provides details of a company's sales, cost of sales, operating expenses and net profit/loss
     *
     * @return $this
     */
    public function setOperatingStatements($operating_statements)
    {
        $this->container['operating_statements'] = $operating_statements;

        return $this;
    }

    /**
     * Gets critical_data_and_financial_ratios
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationCriticalDataAndFinancialRatios[]
     */
    public function getCriticalDataAndFinancialRatios()
    {
        return $this->container['critical_data_and_financial_ratios'];
    }

    /**
     * Sets critical_data_and_financial_ratios
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CorporateFinancialInformationCriticalDataAndFinancialRatios[] $critical_data_and_financial_ratios Financial ratios help to understand the liquidity and solvency of the business
     *
     * @return $this
     */
    public function setCriticalDataAndFinancialRatios($critical_data_and_financial_ratios)
    {
        $this->container['critical_data_and_financial_ratios'] = $critical_data_and_financial_ratios;
