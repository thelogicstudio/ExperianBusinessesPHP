...
/**
 * CollectionScoreRiskClass Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CollectionScoreRiskClass implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CollectionScore_riskClass';
     ...
     * Sets code
     *
     * @param int $code Risk class code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Risk class definition
     *
     * @return $this
     */
