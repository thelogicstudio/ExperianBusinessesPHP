 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NAICSCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NAICSCode';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 120)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 120.";
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling NAICSCode., must be smaller than or equal to 6.');
        }
     ...
     * Sets definition
     *
     * @param string $definition SIC code description
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 120)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling NAICSCode., must be smaller than or equal to 120.');
        }
