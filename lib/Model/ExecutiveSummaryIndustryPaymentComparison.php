...
/**
 * ExecutiveSummaryIndustryPaymentComparison Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryIndustryPaymentComparison implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_industryPaymentComparison';
     ...
     * Sets code
     *
     * @param string $code Industry payment comparison code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Industry payment comparison code description
     *
     * @return $this
     */
