...
/**
 * IntelliscorePlusResponseResultsIntelliscoreScoreInformation Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsIntelliscoreScoreInformation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_intelliscoreScoreInformation';
    ...
    protected static $swaggerTypes = [
        'publicly_held_company' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsPubliclyHeldCompany',
        'limited_profile' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsLimitedProfile',
        'score_info' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreInfo',
        'profile_number' => 'string',
        'model_information' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsModelInformation',
        'probability' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsProbability',
        'action' => 'string',
        'risk_class' => 'string',
        'customer_dispute_statement' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsCustomerDisputeStatement',
    ...
    protected static $swaggerFormats = [
        ...
        'action' => null,
        'risk_class' => null,
        'customer_dispute_statement' => null,
    ...
    protected static $attributeMap = [
        ...
        'customer_dispute_statement' => 'customerDisputeStatement',
    ...
    protected static $setters = [
        ...
        'score_info' => 'setScoreInfo',
        'profile_number' => 'setProfileNumber',
        'model_information' => 'setModelInformation',
        'probability' => 'setProbability',
        'action' => 'setAction',
        'risk_class' => 'setRiskClass',
        'customer_dispute_statement' => 'setCustomerDisputeStatement',
    ...
    protected static $getters = [
        ...
        'score_info' => 'getScoreInfo',
        'profile_number' => 'getProfileNumber',
        'model_information' => 'getModelInformation',
        'probability' => 'getProbability',
        'action' => 'getAction',
        'risk_class' => 'getRiskClass',
        'customer_dispute_statement' => 'getCustomerDisputeStatement',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['score_info'] = isset($data['score_info']) ? $data['score_info'] : null;
        $this->container['profile_number'] = isset($data['profile_number']) ? $data['profile_number'] : null;
        $this->container['model_information'] = isset($data['model_information']) ? $data['model_information'] : null;
        ...
        $this->container['customer_dispute_statement'] = isset($data['customer_dispute_statement']) ? $data['customer_dispute_statement'] : null;
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsPubliclyHeldCompany
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsPubliclyHeldCompany $publicly_held_company publicly_held_company
     *
     * @return $this
     */
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsLimitedProfile
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsLimitedProfile $limited_profile limited_profile
     *
     * @return $this
     */
     ...
     * Gets score_info
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreInfo
     */
    public function getScoreInfo()
    {
        return $this->container['score_info'];
    }

    /**
     * Sets score_info
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreInfo $score_info score_info
     *
     * @return $this
     */
    public function setScoreInfo($score_info)
    {
        $this->container['score_info'] = $score_info;
    ...
    /**
     * Gets model_information
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsModelInformation
     */
    public function getModelInformation()
    {
        return $this->container['model_information'];
    }

    /**
     * Sets model_information
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsModelInformation $model_information model_information
     *
     * @return $this
     */
    public function setModelInformation($model_information)
    {
        $this->container['model_information'] = $model_information;
     ...
     * Gets probability
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsProbability
     */
     ...
     * Sets probability
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsProbability $probability probability
     *
     * @return $this
     */
     ...
     * Sets risk_class
     *
     * @param string $risk_class Risk Class
     *
     * @return $this
     */
    ...
    /**
     * Gets customer_dispute_statement
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsCustomerDisputeStatement
     */
    public function getCustomerDisputeStatement()
    {
        return $this->container['customer_dispute_statement'];
    }

    /**
     * Sets customer_dispute_statement
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsCustomerDisputeStatement $customer_dispute_statement customer_dispute_statement
     *
     * @return $this
     */
    public function setCustomerDisputeStatement($customer_dispute_statement)
    {
        $this->container['customer_dispute_statement'] = $customer_dispute_statement;
     ...
     *
     * @param float $percentile_ranking percentile Ranking
     *
     * @return $this
     */
