...
/**
 * TradeLine Class Doc Comment
 *
 * @category Class
 * @description A credit-related item that is provided by a financial institution or lender including mortgage, line of credit or credit card
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradeLine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradeLine';
    ...
    protected static $swaggerTypes = [
        'tradeline_count' => 'int',
        'current_dbt' => 'int',
        'total_high_credit_amount' => '\TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier',
        'total_account_balance' => '\TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier',
    ...
    protected static $swaggerFormats = [
        'tradeline_count' => 'int64',
        'current_dbt' => 'int64',
        'total_high_credit_amount' => null,
    ...
    protected static $attributeMap = [
        ...
        'total_high_credit_amount' => 'totalHighCreditAmount',
    ...
    protected static $setters = [
        'tradeline_count' => 'setTradelineCount',
        'current_dbt' => 'setCurrentDbt',
        'total_high_credit_amount' => 'setTotalHighCreditAmount',
        'total_account_balance' => 'setTotalAccountBalance',
    ...
    protected static $getters = [
        'tradeline_count' => 'getTradelineCount',
        'current_dbt' => 'getCurrentDbt',
        'total_high_credit_amount' => 'getTotalHighCreditAmount',
        'total_account_balance' => 'getTotalAccountBalance',
    ...
    {
        $this->container['tradeline_count'] = isset($data['tradeline_count']) ? $data['tradeline_count'] : null;
        $this->container['current_dbt'] = isset($data['current_dbt']) ? $data['current_dbt'] : null;
        $this->container['total_high_credit_amount'] = isset($data['total_high_credit_amount']) ? $data['total_high_credit_amount'] : null;
        $this->container['total_account_balance'] = isset($data['total_account_balance']) ? $data['total_account_balance'] : null;
    ...
    /**
     * Gets tradeline_count
     *
     * @return int
     */
    public function getTradelineCount()
    {
        return $this->container['tradeline_count'];
    }

    /**
     * Sets tradeline_count
     *
     * @param int $tradeline_count Number of tradelines
     *
     * @return $this
     */
    public function setTradelineCount($tradeline_count)
    {
        $this->container['tradeline_count'] = $tradeline_count;
    ...
    /**
     * Gets total_high_credit_amount
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier
     */
    public function getTotalHighCreditAmount()
    {
        return $this->container['total_high_credit_amount'];
    }

    /**
     * Sets total_high_credit_amount
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier $total_high_credit_amount total_high_credit_amount
     *
     * @return $this
     */
    public function setTotalHighCreditAmount($total_high_credit_amount)
    {
        $this->container['total_high_credit_amount'] = $total_high_credit_amount;

        return $this;
    }

    /**
     * Gets total_account_balance
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier
     */
    public function getTotalAccountBalance()
    {
        return $this->container['total_account_balance'];
    }

    /**
     * Sets total_account_balance
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\AmountModifier $total_account_balance total_account_balance
     *
     * @return $this
     */
    public function setTotalAccountBalance($total_account_balance)
    {
        $this->container['total_account_balance'] = $total_account_balance;
     ...
     *
     * @param int $current_percentage Current percentage
     *
     * @return $this
     */
     ...
     * Sets dbt30
     *
     * @param int $dbt30 Percentage of the account balance that is beyond terms (late) in the 1-30 day range
     *
     * @return $this
     */
     ...
     * Sets dbt60
     *
     * @param int $dbt60 Percentage of the account balance that is beyond terms (late) in the 31-60 day range
     *
     * @return $this
     */
     ...
     *
     * @param float $number_of_lines Number Of Lines
     *
     * @return $this
     */
