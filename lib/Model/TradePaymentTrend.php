...
/**
 * TradePaymentTrend Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentTrend implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentTrend';
     ...
     * Sets dbt
     *
     * @param int $dbt Days-Beyond-Terms (DBT). The dollar-weighted average number of days beyond the invoice due date a business pays its bills
     *
     * @return $this
     */
     ...
     * Sets dbt60
     *
     * @param int $dbt60 Percentage of the account balance that is beyond terms (late) in the 61-90 day range
     *
     * @return $this
     */
