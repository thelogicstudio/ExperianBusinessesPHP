...
/**
 * TaxIdType Class Doc Comment
 *
 * @category Class
 * @description Returns the type of Tax ID, whether Federal or State
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TaxIdType implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TaxIdType';
     ...
     * Sets code
     *
     * @param string $code Tax ID type code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Tax ID type description
     *
     * @return $this
     */
