...
/**
 * PremierProfilesResponseResultsBondDetails Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PremierProfilesResponseResultsBondDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PremierProfilesResponse_results_bondDetails';
    ...
    protected static $attributeMap = [
        ...
        'bond_effective_date' => 'bondEffectiveDate',
        'bond_number' => 'bondNumber',
        'bond_company' => 'bondCompany'
    ];
    ...
    protected static $setters = [
        'bond_amount' => 'setBondAmount',
        'bond_effective_date' => 'setBondEffectiveDate',
        'bond_number' => 'setBondNumber',
        'bond_company' => 'setBondCompany'
    ];
    ...
    protected static $getters = [
        'bond_amount' => 'getBondAmount',
        'bond_effective_date' => 'getBondEffectiveDate',
        'bond_number' => 'getBondNumber',
        'bond_company' => 'getBondCompany'
    ];
    ...
    {
        $this->container['bond_amount'] = isset($data['bond_amount']) ? $data['bond_amount'] : null;
        $this->container['bond_effective_date'] = isset($data['bond_effective_date']) ? $data['bond_effective_date'] : null;
        $this->container['bond_number'] = isset($data['bond_number']) ? $data['bond_number'] : null;
        $this->container['bond_company'] = isset($data['bond_company']) ? $data['bond_company'] : null;
    }
     ...
     * @return float
     */
    public function getBondAmount()
    {
        return $this->container['bond_amount'];
    }

    /**
     * Sets bond_amount
     *
     * @param float $bond_amount bond Amount
     *
     * @return $this
     */
    public function setBondAmount($bond_amount)
    {
        $this->container['bond_amount'] = $bond_amount;

        return $this;
    }

    /**
     * Gets bond_effective_date
     *
     * @return string
     */
    public function getBondEffectiveDate()
    {
        return $this->container['bond_effective_date'];
    }

    /**
     * Sets bond_effective_date
     *
     * @param string $bond_effective_date Bond Effective Date
     *
     * @return $this
     */
    public function setBondEffectiveDate($bond_effective_date)
    {
        $this->container['bond_effective_date'] = $bond_effective_date;
     ...
     * @return string
     */
    public function getBondNumber()
    {
        return $this->container['bond_number'];
    }

    /**
     * Sets bond_number
     *
     * @param string $bond_number bond Number
     *
     * @return $this
     */
    public function setBondNumber($bond_number)
    {
        $this->container['bond_number'] = $bond_number;
     ...
     * @return string
     */
    public function getBondCompany()
    {
        return $this->container['bond_company'];
    }

    /**
     * Sets bond_company
     *
     * @param string $bond_company Bond Company
     *
     * @return $this
     */
    public function setBondCompany($bond_company)
    {
        $this->container['bond_company'] = $bond_company;
