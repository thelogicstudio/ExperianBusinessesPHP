...
/**
 * BusinessDataRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessDataRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessDataRequest';
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '807205801';
    ...
    {
        if ((mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling BusinessDataRequest., must be smaller than or equal to 9.');
        }
    ...
    public function setSubcode($subcode)
    {
        if ((mb_strlen($subcode) > 7)) {
            throw new \InvalidArgumentException('invalid length for $subcode when calling BusinessDataRequest., must be smaller than or equal to 7.');
        }
