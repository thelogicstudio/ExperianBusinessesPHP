...
/**
 * FsrScoreFactor Class Doc Comment
 *
 * @category Class
 * @description Indicates the factors most influential in lowering the FSR score
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FsrScoreFactor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FsrScoreFactor';
     ...
     * Sets code
     *
     * @param string $code FSR score factor code
     *
     * @return $this
     */
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 6)) {
            throw new \InvalidArgumentException('invalid length for $code when calling FsrScoreFactor., must be smaller than or equal to 6.');
        }
     ...
     * Sets definition
     *
     * @param string $definition FSR score factor description
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 100)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling FsrScoreFactor., must be smaller than or equal to 100.');
        }
