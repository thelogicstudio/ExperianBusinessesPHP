...
/**
 * PremierProfilesResponseResultsInsuranceDetails Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PremierProfilesResponseResultsInsuranceDetails implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PremierProfilesResponse_results_insuranceDetails';
    ...
    protected static $setters = [
        'insurance_effective_date' => 'setInsuranceEffectiveDate',
        'insurance_expiration_date' => 'setInsuranceExpirationDate'
    ];
    ...
    protected static $getters = [
        'insurance_effective_date' => 'getInsuranceEffectiveDate',
        'insurance_expiration_date' => 'getInsuranceExpirationDate'
    ];
    ...
    {
        $this->container['insurance_effective_date'] = isset($data['insurance_effective_date']) ? $data['insurance_effective_date'] : null;
        $this->container['insurance_expiration_date'] = isset($data['insurance_expiration_date']) ? $data['insurance_expiration_date'] : null;
    }
    ...
    /**
     * Gets insurance_effective_date
     *
     * @return string
     */
    public function getInsuranceEffectiveDate()
    {
        return $this->container['insurance_effective_date'];
    }

    /**
     * Sets insurance_effective_date
     *
     * @param string $insurance_effective_date Insurance Effective Date
     *
     * @return $this
     */
    public function setInsuranceEffectiveDate($insurance_effective_date)
    {
        $this->container['insurance_effective_date'] = $insurance_effective_date;

        return $this;
    }

    /**
     * Gets insurance_expiration_date
     *
     * @return string
     */
    public function getInsuranceExpirationDate()
    {
        return $this->container['insurance_expiration_date'];
    }

    /**
     * Sets insurance_expiration_date
     *
     * @param string $insurance_expiration_date Insurance Expiration Date
     *
     * @return $this
     */
    public function setInsuranceExpirationDate($insurance_expiration_date)
    {
        $this->container['insurance_expiration_date'] = $insurance_expiration_date;
