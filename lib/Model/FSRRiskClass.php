...
/**
 * FSRRiskClass Class Doc Comment
 *
 * @category Class
 * @description FSR score risk class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FSRRiskClass implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FSRRiskClass';
     ...
     * Sets code
     *
     * @param int $code 1 = \"Low Risk\", 2 = \"Low to Medium Risk\", 3 = \"Medium Risk\", 4 = \"Medium to High Risk\", 5 = \"High Risk\", 998 = \"Recent bankruptcy on file\", 999 = \"Insufficient data to score\"
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition FSR score risk class default values \"High Risk\", \"Medium to High Risk\", \"Medium Risk\", \"Low to Medium Risk\", \"Low Risk\", \"Recent Bankruptcy on file\", \"Insufficient data to score\"
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 50)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling FSRRiskClass., must be smaller than or equal to 50.');
        }
