...
/**
 * TradePaymentExperiencesResultPaymentIndicator Class Doc Comment
 *
 * @category Class
 * @description Indication of how the subject pays the account relative to others within the industry
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentExperiencesResultPaymentIndicator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentExperiencesResult_paymentIndicator';
     ...
     * Sets code
     *
     * @param string $code \"-\" = Pays slower. \"=\" = Pays the same. \"+\" = Pays faster. Blank = No Indicator
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Payment Indicator description
     *
     * @return $this
     */
