...
/**
 * IntelliscorePlusResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'success' => 'bool',
        'comments' => 'string',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResults'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['comments'] = isset($data['comments']) ? $data['comments'] : 'test123';
     ...
     * Gets results
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResults
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResults $results results
     *
     * @return $this
     */
