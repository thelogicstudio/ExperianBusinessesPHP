...
/**
 * GovernmentActivity Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentActivity implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'governmentActivity';
     ...
     *
     * @param string $congressional_district The state congressional district as defined by the business address. Code is presented as 2-digits. District is available for standardized addresses within the 50 states
     *
     * @return $this
     */
     ...
     * Sets contractor
     *
     * @param string $contractor Business enterprise is included in the US Federal Central Contractor Registry
     *
     * @return $this
     */
     ...
     *
     * @param string $debarred_indicator Business enterprise is included on the Federal Government Excluded Parties List System. This system presents those parties excluded from receiving federal contracts, certain subcontracts, and certain types of federal financial and non-financial assistance and benefits
     *
     * @return $this
     */
     ...
     * Sets agency
     *
     * @param string $agency Federal agency taking the exclusion action as presented in the Federal Government Excluded Parties List System
     *
     * @return $this
     */
     ...
     * Sets exclusion_type
     *
     * @param string $exclusion_type Exclusion Type as presented in the Federal Government Excluded Parties List System: Preliminarily Ineligible (Proceeding Pending), Ineligible (Proceedings Completed), Prohibition/Restriction, Voluntary Exclusion
     *
     * @return $this
     */
     ...
     * Sets active_date
     *
     * @param string $active_date The start date of the exclusion for the debarred party as presented in the Federal Government Excluded Parties List System
     *
     * @return $this
     */
     ...
     *
     * @param string $termination_date Date the exclusion will be terminated as presented in the Federal Government Excluded Parties List System.
     *
     * @return $this
     */
     ...
     *
     * @param string $import_export_code Import Export code
     *
     * @return $this
     */
