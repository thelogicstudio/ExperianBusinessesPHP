...
/**
 * ExecutiveSummaryBusinessDbt Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryBusinessDbt implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_businessDbt';
     ...
     * Sets code
     *
     * @param float $code DBT Code. Days-Beyond-Terms (DBT). The dollar-weighted average number of days beyond the invoice due date a business pays its bills
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition DBT description.
     *
     * @return $this
     */
