...
/**
 * BusinessFactsFileEstablishedFlag Class Doc Comment
 *
 * @category Class
 * @description Indicates if the business was added to the Experian database prior to January 1977
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessFactsFileEstablishedFlag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessFacts_fileEstablishedFlag';
     ...
     * Sets code
     *
     * @param string $code P = Business was added prior to Jan 1977
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition File established flag definition
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 50)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling BusinessFactsFileEstablishedFlag., must be smaller than or equal to 50.');
        }
