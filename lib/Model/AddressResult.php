 ...
 *
 * @category Class
 * @description JSON object that holds address information on the business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressResult';
     ...
     * Sets street
     *
     * @param string $street Street address of the business, include suite number if applicable
     *
     * @return $this
     */
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling AddressResult., must be smaller than or equal to 40.');
        }
     ...
     * Sets city
     *
     * @param string $city City of the business address
     *
     * @return $this
     */
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AddressResult., must be smaller than or equal to 30.');
        }
     ...
     * Sets state
     *
     * @param string $state State of the business address
     *
     * @return $this
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling AddressResult., must be smaller than or equal to 2.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling AddressResult., must be smaller than or equal to 5.');
        }
    ...
    public function setZipExtension($zip_extension)
    {
        if (!is_null($zip_extension) && (mb_strlen($zip_extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $zip_extension when calling AddressResult., must be smaller than or equal to 4.');
        }
