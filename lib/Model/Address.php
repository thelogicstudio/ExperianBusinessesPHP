...
class Address implements ModelInterface, ArrayAccess
{
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling Address., must be smaller than or equal to 40.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling Address., must be smaller than or equal to 2.');
        }
     ...
     * Sets zip
     *
     * @param string $zip 9-digit zip code of the business address
     *
     * @return $this
     */
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling Address., must be smaller than or equal to 5.');
        }
     ...
     * Sets zip_extension
     *
     * @param string $zip_extension 4-digit zip code of the business address
     *
     * @return $this
     */
    public function setZipExtension($zip_extension)
    {
        if (!is_null($zip_extension) && (mb_strlen($zip_extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $zip_extension when calling Address., must be smaller than or equal to 4.');
        }
