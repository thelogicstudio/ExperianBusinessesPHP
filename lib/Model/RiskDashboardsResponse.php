...
class RiskDashboardsResponse extends BusinessDataResponse 
{
    ...
    protected static $swaggerTypes = [
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResultRiskDashboard'
    ];
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResultRiskDashboard $results results
     *
     * @return $this
     */
