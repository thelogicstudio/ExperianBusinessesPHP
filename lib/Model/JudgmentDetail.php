...
class JudgmentDetail implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['plaintiff_name']) && (mb_strlen($this->container['plaintiff_name']) > 35)) {
            $invalidProperties[] = "invalid value for 'plaintiff_name', the character length must be smaller than or equal to 35.";
        }
    ...
    public function setLegalType($legal_type)
    {
        if (!is_null($legal_type) && (mb_strlen($legal_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $legal_type when calling JudgmentDetail., must be smaller than or equal to 2.');
        }
    ...
    public function setLegalAction($legal_action)
    {
        if (!is_null($legal_action) && (mb_strlen($legal_action) > 2)) {
            throw new \InvalidArgumentException('invalid length for $legal_action when calling JudgmentDetail., must be smaller than or equal to 2.');
        }
    ...
    public function setDocumentNumber($document_number)
    {
        if (!is_null($document_number) && (mb_strlen($document_number) > 16)) {
            throw new \InvalidArgumentException('invalid length for $document_number when calling JudgmentDetail., must be smaller than or equal to 16.');
        }
    ...
    public function setFilingLocation($filing_location)
    {
        if (!is_null($filing_location) && (mb_strlen($filing_location) > 20)) {
            throw new \InvalidArgumentException('invalid length for $filing_location when calling JudgmentDetail., must be smaller than or equal to 20.');
        }
    ...
    {
        if (!is_null($plaintiff_name) && (mb_strlen($plaintiff_name) > 35)) {
            throw new \InvalidArgumentException('invalid length for $plaintiff_name when calling JudgmentDetail., must be smaller than or equal to 35.');
        }
