...
/**
 * ScoresSearchRequestCollectionScore Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScoresSearchRequestCollectionScore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ScoresSearchRequest_collectionScore';
    ...
    protected static $attributeMap = [
        'collection_model_code' => 'collectionModelCode',
    ...
    protected static $setters = [
        'collection_model_code' => 'setCollectionModelCode',
    ...
    protected static $getters = [
        'collection_model_code' => 'getCollectionModelCode',
    ...
    {
        $this->container['collection_model_code'] = isset($data['collection_model_code']) ? $data['collection_model_code'] : null;
    ...
    /**
     * Gets collection_model_code
     *
     * @return string
     */
    public function getCollectionModelCode()
    {
        return $this->container['collection_model_code'];
    }

    /**
     * Sets collection_model_code
     *
     * @param string $collection_model_code \"000243\" for Commercial Recovery Score Logistic Regression, or \"000245\" for Commercial Recovery Score Machine Learning
     *
     * @return $this
     */
    public function setCollectionModelCode($collection_model_code)
    {
        $this->container['collection_model_code'] = $collection_model_code;
     ...
     *
     * @param float $collection_balance Required field when submitting for a Collections Score, otherwise the Collections Score will always generate a 997 code stating the Collection Balance was not submitted
     *
     * @return $this
     */
