...
/**
 * CollectionScore Class Doc Comment
 *
 * @category Class
 * @description Collection score object for the business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CollectionScore implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CollectionScore';
    ...
    protected static $swaggerTypes = [
        ...
        'risk_class' => '\TheLogicStudio\ExperianBusinessesPHP\Model\CollectionScoreRiskClass'
    ];
     ...
     * Sets model_code
     *
     * @param string $model_code Collection score model
     *
     * @return $this
     */
     ...
     * Sets model_title
     *
     * @param string $model_title Collection score model title
     *
     * @return $this
     */
     ...
     * Sets score
     *
     * @param int $score Collection score if the business
     *
     * @return $this
     */
     ...
     *
     * @param int $percentile_ranking Percentile ranking
     *
     * @return $this
     */
     ...
     * Gets risk_class
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CollectionScoreRiskClass
     */
     ...
     * Sets risk_class
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CollectionScoreRiskClass $risk_class risk_class
     *
     * @return $this
     */
