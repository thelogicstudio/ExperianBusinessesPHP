...
class CorporateLinkageFull implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['ultimate_bin']) && (mb_strlen($this->container['ultimate_bin']) > 9)) {
            $invalidProperties[] = "invalid value for 'ultimate_bin', the character length must be smaller than or equal to 9.";
        }

        if (!is_null($this->container['parent_bin']) && (mb_strlen($this->container['parent_bin']) > 9)) {
            $invalidProperties[] = "invalid value for 'parent_bin', the character length must be smaller than or equal to 9.";
        }

        if (!is_null($this->container['commercial_risk_class']) && (mb_strlen($this->container['commercial_risk_class']) > 20)) {
            $invalidProperties[] = "invalid value for 'commercial_risk_class', the character length must be smaller than or equal to 20.";
        }
    ...
    public function setCorporateLinkageType($corporate_linkage_type)
    {
        if (!is_null($corporate_linkage_type) && (mb_strlen($corporate_linkage_type) > 30)) {
            throw new \InvalidArgumentException('invalid length for $corporate_linkage_type when calling CorporateLinkageFull., must be smaller than or equal to 30.');
        }
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling CorporateLinkageFull., must be smaller than or equal to 9.');
        }
    ...
    public function setBusinessName($business_name)
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling CorporateLinkageFull., must be smaller than or equal to 120.');
        }
    ...
    {
        if (!is_null($ultimate_bin) && (mb_strlen($ultimate_bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $ultimate_bin when calling CorporateLinkageFull., must be smaller than or equal to 9.');
        }
    ...
    {
        if (!is_null($parent_bin) && (mb_strlen($parent_bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $parent_bin when calling CorporateLinkageFull., must be smaller than or equal to 9.');
        }
    ...
    {
        if (!is_null($commercial_risk_class) && (mb_strlen($commercial_risk_class) > 20)) {
            throw new \InvalidArgumentException('invalid length for $commercial_risk_class when calling CorporateLinkageFull., must be smaller than or equal to 20.');
        }
