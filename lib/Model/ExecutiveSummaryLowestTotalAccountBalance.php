...
/**
 * ExecutiveSummaryLowestTotalAccountBalance Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryLowestTotalAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_lowestTotalAccountBalance';
     ...
     * Sets amount
     *
     * @param float $amount Lowest total account balance
     *
     * @return $this
     */
