...
/**
 * BCIResponseResultsCorporateLinkageFull Class Doc Comment
 *
 * @category Class
 * @description corporate LinkageF ull
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BCIResponseResultsCorporateLinkageFull implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BCIResponse_results_corporateLinkageFull';
    ...
    protected static $swaggerTypes = [
        'corporate_linkage_partial' => '\TheLogicStudio\ExperianBusinessesPHP\Model\CorporateLinkageFull[]'
    ];
