...
/**
 * CorporateFinancialInformationOperatingStatements Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CorporateFinancialInformationOperatingStatements implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'corporateFinancialInformation_operatingStatements';
    ...
    protected static $attributeMap = [
        ...
        'gross_income_on_sales' => 'grossIncomeOnSales',
        'expenses' => 'expenses',
    ...
    protected static $setters = [
        ...
        'gross_income_on_sales' => 'setGrossIncomeOnSales',
        'expenses' => 'setExpenses',
        'pre_tax_income' => 'setPreTaxIncome',
        'taxes' => 'setTaxes',
        'after_taxes' => 'setAfterTaxes',
    ...
    protected static $getters = [
        ...
        'gross_income_on_sales' => 'getGrossIncomeOnSales',
        'expenses' => 'getExpenses',
        'pre_tax_income' => 'getPreTaxIncome',
        'taxes' => 'getTaxes',
        'after_taxes' => 'getAfterTaxes',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['gross_income_on_sales'] = isset($data['gross_income_on_sales']) ? $data['gross_income_on_sales'] : null;
        $this->container['expenses'] = isset($data['expenses']) ? $data['expenses'] : null;
        $this->container['pre_tax_income'] = isset($data['pre_tax_income']) ? $data['pre_tax_income'] : null;
        $this->container['taxes'] = isset($data['taxes']) ? $data['taxes'] : null;
        $this->container['after_taxes'] = isset($data['after_taxes']) ? $data['after_taxes'] : null;
     ...
     * Sets net_sales
     *
     * @param float $net_sales The amount of sales recorded after the deduction of returns, allowances, and discounts
     *
     * @return $this
     */
     ...
     *
     * @param float $cost_of_goods_sold Total amount of cost of goods sold, which are the direct costs attributable to the production of goods sold by the company
     *
     * @return $this
     */
    ...
    /**
     * Gets gross_income_on_sales
     *
     * @return float
     */
    public function getGrossIncomeOnSales()
    {
        return $this->container['gross_income_on_sales'];
    }

    /**
     * Sets gross_income_on_sales
     *
     * @param float $gross_income_on_sales Total amount of gross income, which is Net Sales minus Cost of Goods Sold (COGS)
     *
     * @return $this
     */
    public function setGrossIncomeOnSales($gross_income_on_sales)
    {
        $this->container['gross_income_on_sales'] = $gross_income_on_sales;
     ...
     * Sets expenses
     *
     * @param float $expenses Total amount of expenses
     *
     * @return $this
     */
    ...
    {
        return $this->container['pre_tax_income'];
    }

    /**
     * Sets pre_tax_income
     *
     * @param float $pre_tax_income Total amount of pre-tax income
     *
     * @return $this
     */
    public function setPreTaxIncome($pre_tax_income)
    {
        $this->container['pre_tax_income'] = $pre_tax_income;
     ...
     * @return float
     */
    public function getAfterTaxes()
    {
        return $this->container['after_taxes'];
    }

    /**
     * Sets after_taxes
     *
     * @param float $after_taxes Total after taxes
     *
     * @return $this
     */
    public function setAfterTaxes($after_taxes)
    {
        $this->container['after_taxes'] = $after_taxes;
     ...
     *
     * @param float $extraordinary_income Total amount of extraordinary income
     *
     * @return $this
     */
