...
/**
 * ISTWatchRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ISTWatchRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ISTWatchRequest';
    ...
    protected static $setters = [
        ...
        'maximum_results' => 'setMaximumResults',
    ...
    protected static $getters = [
        ...
        'maximum_results' => 'getMaximumResults',
    ...
    {
        $this->container['name'] = isset($data['name']) ? $data['name'] : 'Bank Melli Iran';
        $this->container['city'] = isset($data['city']) ? $data['city'] : 'Paris';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['street'] = isset($data['street']) ? $data['street'] : '43 Avenue Montaigne';
        $this->container['country'] = isset($data['country']) ? $data['country'] : 'FR';
        $this->container['score_threshold'] = isset($data['score_threshold']) ? $data['score_threshold'] : null;
        $this->container['maximum_results'] = isset($data['maximum_results']) ? $data['maximum_results'] : '3';
     ...
     *
     * @param float $score_threshold scoreThreshold
     *
     * @return $this
     */
    ...
    /**
     * Gets maximum_results
     *
     * @return string
     */
    public function getMaximumResults()
    {
        return $this->container['maximum_results'];
    }

    /**
     * Sets maximum_results
     *
     * @param string $maximum_results Maximum Results
     *
     * @return $this
     */
    public function setMaximumResults($maximum_results)
    {
        $this->container['maximum_results'] = $maximum_results;
