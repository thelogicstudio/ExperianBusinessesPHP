...
/**
 * MultiSegmentsResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiSegmentsResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiSegmentsResponse';
    ...
    protected static $swaggerTypes = [
        ...
        'success' => 'bool',
        'comments' => 'string',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResult'
    ];
    ...
    public function setRequestId($request_id)
    {
        if (!is_null($request_id) && (mb_strlen($request_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $request_id when calling MultiSegmentsResponse., must be smaller than or equal to 50.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 30)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling MultiSegmentsResponse., must be smaller than or equal to 30.');
        }
     ...
     * Gets results
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResult
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\MultiSegmentsResult $results Object containing Corporate Registration information
     *
     * @return $this
     */
