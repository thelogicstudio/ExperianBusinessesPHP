...
/**
 * BusinessPremierProfileRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessPremierProfileRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessPremierProfileRequest';
    ...
    protected static $setters = [
        ...
        'business_aggregates' => 'setBusinessAggregates'
    ];
    ...
    protected static $getters = [
        ...
        'business_aggregates' => 'getBusinessAggregates'
    ];
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '800914632';
        ...
        $this->container['business_aggregates'] = isset($data['business_aggregates']) ? $data['business_aggregates'] : false;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['model_code'] === null) {
            $invalidProperties[] = "'model_code' can't be null";
        }
     ...
     * Sets model_code
     *
     * @param string $model_code Experian Risk Model Code. Default is \"000254\"
     *
     * @return $this
     */
    ...
    /**
     * Gets business_aggregates
     *
     * @return bool
     */
    public function getBusinessAggregates()
    {
        return $this->container['business_aggregates'];
    }

    /**
     * Sets business_aggregates
     *
     * @param bool $business_aggregates An optional boolean flag that indicates whether to deliver BizAggs with the Premier Profile
     *
     * @return $this
     */
    public function setBusinessAggregates($business_aggregates)
    {
        $this->container['business_aggregates'] = $business_aggregates;
