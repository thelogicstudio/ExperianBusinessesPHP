...
/**
 * BusinessCollectionsRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessCollectionsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessCollectionsRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'collections_summary' => 'bool',
        'collections_detail' => 'bool'
    ];
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '700880075';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['collections_summary'] = isset($data['collections_summary']) ? $data['collections_summary'] : true;
        $this->container['collections_detail'] = isset($data['collections_detail']) ? $data['collections_detail'] : true;
    }
     ...
     *
     * @param bool $collections_summary If true receive object containing collection count and collection balance
     *
     * @return $this
     */
     ...
     *
     * @param bool $collections_detail If true receive object containing details of collections accounts on file. Collections remain on file for up to 6 years
     *
     * @return $this
     */
