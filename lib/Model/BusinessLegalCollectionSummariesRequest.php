...
/**
 * BusinessLegalCollectionSummariesRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessLegalCollectionSummariesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessLegalCollectionSummariesRequest';
    ...
    protected static $swaggerTypes = [
        'bin' => 'string',
        'subcode' => 'string',
        'legal_filings_collections_summary' => 'bool',
        'legal_filings_summary' => 'bool'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['legal_filings_collections_summary'] = isset($data['legal_filings_collections_summary']) ? $data['legal_filings_collections_summary'] : true;
        $this->container['legal_filings_summary'] = isset($data['legal_filings_summary']) ? $data['legal_filings_summary'] : true;
    }
     ...
     *
     * @param bool $legal_filings_collections_summary Contains summary information on all legal items, including bankruptices, liens, judgments, UCC filings, and collections
     *
     * @return $this
     */
     ...
     *
     * @param bool $legal_filings_summary Contains legal count and legal balance only
     *
     * @return $this
     */
