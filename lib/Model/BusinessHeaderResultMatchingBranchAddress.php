...
/**
 * BusinessHeaderResultMatchingBranchAddress Class Doc Comment
 *
 * @category Class
 * @description Matching Branch Address
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessHeaderResultMatchingBranchAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessHeaderResult_matchingBranchAddress';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['zip_extension'] = isset($data['zip_extension']) ? $data['zip_extension'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['zip_extension']) && (mb_strlen($this->container['zip_extension']) > 4)) {
            $invalidProperties[] = "invalid value for 'zip_extension', the character length must be smaller than or equal to 4.";
        }
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 9.');
        }
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 255)) {
            throw new \InvalidArgumentException('invalid length for $street when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 255.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 50)) {
            throw new \InvalidArgumentException('invalid length for $city when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 50.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 2.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 9)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 9.');
        }
     ...
     * Sets zip_extension
     *
     * @param string $zip_extension +4 zip extension
     *
     * @return $this
     */
    public function setZipExtension($zip_extension)
    {
        if (!is_null($zip_extension) && (mb_strlen($zip_extension) > 4)) {
            throw new \InvalidArgumentException('invalid length for $zip_extension when calling BusinessHeaderResultMatchingBranchAddress., must be smaller than or equal to 4.');
        }
