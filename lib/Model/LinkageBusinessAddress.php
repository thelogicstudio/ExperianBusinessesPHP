...
/**
 * LinkageBusinessAddress Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LinkageBusinessAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LinkageBusinessAddress';
     ...
     * Sets street
     *
     * @param string $street Street address of the business, including suite number if applicable
     *
     * @return $this
     */
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 60)) {
            throw new \InvalidArgumentException('invalid length for $street when calling LinkageBusinessAddress., must be smaller than or equal to 60.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 40)) {
            throw new \InvalidArgumentException('invalid length for $city when calling LinkageBusinessAddress., must be smaller than or equal to 40.');
        }
     ...
     * Sets state
     *
     * @param string $state State. Only populated for US businesses
     *
     * @return $this
     */
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling LinkageBusinessAddress., must be smaller than or equal to 2.');
        }
    ...
    public function setCountry($country)
    {
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling LinkageBusinessAddress., must be smaller than or equal to 3.');
        }
