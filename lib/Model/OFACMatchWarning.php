...
/**
 * OFACMatchWarning Class Doc Comment
 *
 * @category Class
 * @description Provides indication if the business name or address may contain possible matching to the Office of Foreign Assets Control (OFAC) list. Possible values include Code 1 &#x3D; \&quot;No OFAC match found\&quot;, Code 11 &#x3D; \&quot;OFAC match to company name only\&quot;, Code 12 &#x3D; \&quot;OFAC match to business address only\&quot;, Code 13 &#x3D; \&quot;OFAC match to company name and address\&quot;, Code null &#x3D; \&quot;No OFAC match attempt made\&quot;
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class OFACMatchWarning implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'OFACMatchWarning';
    ...
    protected static $attributeMap = [
        ...
        'detail_statement' => 'detailStatement'
    ];
    ...
    protected static $setters = [
        ...
        'detail_statement' => 'setDetailStatement'
    ];
    ...
    protected static $getters = [
        ...
        'detail_statement' => 'getDetailStatement'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['detail_statement'] = isset($data['detail_statement']) ? $data['detail_statement'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 20)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 20.";
        }
     ...
     * Sets code
     *
     * @param float $code OFAC match code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition OFAC match description
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 20)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling OFACMatchWarning., must be smaller than or equal to 20.');
        }
    ...
    /**
     * Gets detail_statement
     *
     * @return string
     */
    public function getDetailStatement()
    {
        return $this->container['detail_statement'];
    }

    /**
     * Sets detail_statement
     *
     * @param string $detail_statement Only returned if there is an OFAC match. Long string containing the block of information from the OFAC list where the match occurred
     *
     * @return $this
     */
    public function setDetailStatement($detail_statement)
    {
        $this->container['detail_statement'] = $detail_statement;
