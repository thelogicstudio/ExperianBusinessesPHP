...
/**
 * GovernmentDetailsResultGovernmentActivityAgency Class Doc Comment
 *
 * @category Class
 * @description Government agency that took the exclusion action
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResultGovernmentActivityAgency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult_governmentActivity_agency';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 30)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 30.";
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling GovernmentDetailsResultGovernmentActivityAgency., must be smaller than or equal to 20.');
        }
    ...
    {
        if (!is_null($definition) && (mb_strlen($definition) > 30)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling GovernmentDetailsResultGovernmentActivityAgency., must be smaller than or equal to 30.');
        }
