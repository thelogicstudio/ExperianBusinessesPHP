...
/**
 * BusinessReverseTaxIDsRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessReverseTaxIDsRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessReverseTaxIDsRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['tax_id'] = isset($data['tax_id']) ? $data['tax_id'] : '222152871';
    }
     ...
     * Sets tax_id
     *
     * @param string $tax_id 9-digit Federal Tax Identification Number or Employer Identification Number (EIN)
     *
     * @return $this
     */
