...
class SearchResponse implements ModelInterface, ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        ...
        'comments' => 'string',
        'success' => 'bool',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\SearchResult[]'
    ];
    ...
    public function setRequestId($request_id)
    {
        if (!is_null($request_id) && (mb_strlen($request_id) > 50)) {
            throw new \InvalidArgumentException('invalid length for $request_id when calling SearchResponse., must be smaller than or equal to 50.');
        }
     ...
     *
     * @param string $response_message A message describing the response and providing suggestions for search improvement.
     *
     * @return $this
     */
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 30)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling SearchResponse., must be smaller than or equal to 30.');
        }
     ...
     * Sets success
     *
     * @param bool $success Response success (e.g. false)
     *
     * @return $this
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\SearchResult[] $results An array(list) of businesses that match the search request
     *
     * @return $this
     */
