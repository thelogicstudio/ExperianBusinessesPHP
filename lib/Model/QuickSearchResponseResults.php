...
/**
 * QuickSearchResponseResults Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class QuickSearchResponseResults implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'QuickSearchResponse_results';
    ...
    protected static $swaggerTypes = [
        ...
        'city' => 'string',
        'street' => 'string',
        'display_other_bus_names' => 'string[]',
        'rank' => 'float',
        'phone' => 'string',
        'state' => 'string',
        'contact' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'city' => 'city',
        'street' => 'street',
        'display_other_bus_names' => 'displayOtherBusNames',
        'rank' => 'rank',
        'phone' => 'phone',
        'state' => 'state',
        'contact' => 'contact',
    ...
    protected static $setters = [
        ...
        'city' => 'setCity',
        'street' => 'setStreet',
        'display_other_bus_names' => 'setDisplayOtherBusNames',
        'rank' => 'setRank',
        'phone' => 'setPhone',
        'state' => 'setState',
        'contact' => 'setContact',
    ...
    protected static $getters = [
        ...
        'city' => 'getCity',
        'street' => 'getStreet',
        'display_other_bus_names' => 'getDisplayOtherBusNames',
        'rank' => 'getRank',
        'phone' => 'getPhone',
        'state' => 'getState',
        'contact' => 'getContact',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['display_other_bus_names'] = isset($data['display_other_bus_names']) ? $data['display_other_bus_names'] : null;
        $this->container['rank'] = isset($data['rank']) ? $data['rank'] : null;
        $this->container['phone'] = isset($data['phone']) ? $data['phone'] : null;
        $this->container['state'] = isset($data['state']) ? $data['state'] : null;
        $this->container['contact'] = isset($data['contact']) ? $data['contact'] : null;
        $this->container['bus_name'] = isset($data['bus_name']) ? $data['bus_name'] : null;
        $this->container['contact_title'] = isset($data['contact_title']) ? $data['contact_title'] : null;
        $this->container['zip5'] = isset($data['zip5']) ? $data['zip5'] : null;
    }
    ...
    /**
     * Gets display_other_bus_names
     *
     * @return string[]
     */
    public function getDisplayOtherBusNames()
    {
        return $this->container['display_other_bus_names'];
    }

    /**
     * Sets display_other_bus_names
     *
     * @param string[] $display_other_bus_names Display Other Business Names
     *
     * @return $this
     */
    public function setDisplayOtherBusNames($display_other_bus_names)
    {
        $this->container['display_other_bus_names'] = $display_other_bus_names;
    ...
    {
        return $this->container['bus_name'];
    }

    /**
     * Sets bus_name
     *
     * @param string $bus_name Business name
     *
     * @return $this
     */
    public function setBusName($bus_name)
    {
        $this->container['bus_name'] = $bus_name;
     ...
     * Sets contact_title
     *
     * @param string $contact_title contactTitle
     *
     * @return $this
     */
