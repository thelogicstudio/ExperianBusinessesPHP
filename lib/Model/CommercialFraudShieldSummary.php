...
/**
 * CommercialFraudShieldSummary Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommercialFraudShieldSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommercialFraudShieldSummary';
    ...
    protected static $swaggerTypes = [
        'matching_business_indicator' => 'string',
     ...
     *
     * @param string $matching_business_indicator \"Primary Business\" is returned when the address inquired upon matches the businesses primary address. \"Branch Business\" is returned when the address matches a branch location. Null if not available
     *
     * @return $this
     */
     ...
     *
     * @param bool $active_business_indicator Indicates if Experian shows activity for this business within the BizSource database To determine active status, Experian looks at bankruptcies, corporate registrations, trades, collections, and recent credit inquiry activity
     *
     * @return $this
     */
     ...
     *
     * @param bool $business_risk_triggers_indicator If yes, indicates high risk conditions associated with the business address
     *
     * @return $this
     */
     ...
     *
     * @param bool $name_address_verification_indicator If yes there are potential inconsistencies with the business name, address, phone and Tax ID Number
     *
     * @return $this
     */
