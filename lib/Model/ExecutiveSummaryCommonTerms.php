...
/**
 * ExecutiveSummaryCommonTerms Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryCommonTerms implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_commonTerms';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['third'] = isset($data['third']) ? $data['third'] : null;
    }
     ...
     * Sets first
     *
     * @param string $first Most common payment terms
     *
     * @return $this
     */
     ...
     * Sets second
     *
     * @param string $second Second most common payment terms
     *
     * @return $this
     */
    ...
    {
        return $this->container['third'];
    }

    /**
     * Sets third
     *
     * @param string $third Third most common payment terms
     *
     * @return $this
     */
    public function setThird($third)
    {
        $this->container['third'] = $third;
