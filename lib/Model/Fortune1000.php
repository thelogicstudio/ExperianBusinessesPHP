...
/**
 * Fortune1000 Class Doc Comment
 *
 * @category Class
 * @description Fortune 1000
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Fortune1000 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Fortune1000';
     ...
     * Sets year
     *
     * @param float $year Year in which the business was a Fortune 1000 company
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param float $rank Rank of the business on the list of the Fortune 1000 companies
     *
     * @return $this
     */
