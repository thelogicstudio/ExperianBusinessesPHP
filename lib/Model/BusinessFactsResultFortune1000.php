...
/**
 * BusinessFactsResultFortune1000 Class Doc Comment
 *
 * @category Class
 * @description Object representing if the business was listed on the Fortune 1000 list in the past 3 years (if not ever listed the value will be null)
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessFactsResultFortune1000 implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessFactsResult_fortune1000';
     ...
     * Sets year
     *
     * @param float $year year of fortune1000 list
     *
     * @return $this
     */
     ...
     * Sets rank
     *
     * @param float $rank rank in fortune1000 list
     *
     * @return $this
     */
