...
/**
 * TradePaymentExperiencesResultTradelineFlag Class Doc Comment
 *
 * @category Class
 * @description Flag indicating a special tradeline
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentExperiencesResultTradelineFlag implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentExperiencesResult_tradelineFlag';
     ...
     * Sets code
     *
     * @param string $code Tradline Flag code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Tradeline Flag description
     *
     * @return $this
     */
