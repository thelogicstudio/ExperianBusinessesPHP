...
/**
 * CommercialScoreFactor Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommercialScoreFactor implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommercialScoreFactor';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['code']) && (mb_strlen($this->container['code']) > 5)) {
            $invalidProperties[] = "invalid value for 'code', the character length must be smaller than or equal to 5.";
        }

        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 100)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 100.";
        }
     ...
     * Sets code
     *
     * @param string $code Commercial score factor code
     *
     * @return $this
     */
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 5)) {
            throw new \InvalidArgumentException('invalid length for $code when calling CommercialScoreFactor., must be smaller than or equal to 5.');
        }
     ...
     * Sets definition
     *
     * @param string $definition Commercial score factor description
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 100)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling CommercialScoreFactor., must be smaller than or equal to 100.');
        }
