...
/**
 * BusinessHeaderResultBranchLocation Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessHeaderResultBranchLocation implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessHeaderResult_branchLocation';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['location_id'] = isset($data['location_id']) ? $data['location_id'] : '475 ANTON BLVD';
    }
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling BusinessHeaderResultBranchLocation., must be smaller than or equal to 9.');
        }
     ...
     * Sets location_id
     *
     * @param string $location_id locationId
     *
     * @return $this
     */
