...
/**
 * BusinessContactsResult Class Doc Comment
 *
 * @category Class
 * @description Business Contacts information
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessContactsResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessContactsResult';
    ...
    protected static $swaggerTypes = [
        'individual_owners_and_principals' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IndividualOwnersAndPrincipalsResult[]',
        'company_owners_and_principals' => '\TheLogicStudio\ExperianBusinessesPHP\Model\CompanyOwnersAndPrincipalsResult[]',
        'contacts_and_titles' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ContactsAndTitlesResult[]',
        'contacts_business_affiliations' => '\TheLogicStudio\ExperianBusinessesPHP\Model\ContactsBusinessAffiliationsResult[]'
    ];
    ...
    protected static $swaggerFormats = [
        'individual_owners_and_principals' => null,
        'company_owners_and_principals' => null,
        'contacts_and_titles' => null,
        'contacts_business_affiliations' => null
    ];
    ...
    protected static $attributeMap = [
        'individual_owners_and_principals' => 'individualOwnersAndPrincipals',
        'company_owners_and_principals' => 'companyOwnersAndPrincipals',
        'contacts_and_titles' => 'contactsAndTitles',
        'contacts_business_affiliations' => 'contactsBusinessAffiliations'
    ];
    ...
    protected static $setters = [
        'individual_owners_and_principals' => 'setIndividualOwnersAndPrincipals',
        'company_owners_and_principals' => 'setCompanyOwnersAndPrincipals',
        'contacts_and_titles' => 'setContactsAndTitles',
        'contacts_business_affiliations' => 'setContactsBusinessAffiliations'
    ];
    ...
    protected static $getters = [
        'individual_owners_and_principals' => 'getIndividualOwnersAndPrincipals',
        'company_owners_and_principals' => 'getCompanyOwnersAndPrincipals',
        'contacts_and_titles' => 'getContactsAndTitles',
        'contacts_business_affiliations' => 'getContactsBusinessAffiliations'
    ];
    ...
    {
        $this->container['individual_owners_and_principals'] = isset($data['individual_owners_and_principals']) ? $data['individual_owners_and_principals'] : null;
        $this->container['company_owners_and_principals'] = isset($data['company_owners_and_principals']) ? $data['company_owners_and_principals'] : null;
        $this->container['contacts_and_titles'] = isset($data['contacts_and_titles']) ? $data['contacts_and_titles'] : null;
        $this->container['contacts_business_affiliations'] = isset($data['contacts_business_affiliations']) ? $data['contacts_business_affiliations'] : null;
    }
    ...
    /**
     * Gets individual_owners_and_principals
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IndividualOwnersAndPrincipalsResult[]
     */
    public function getIndividualOwnersAndPrincipals()
    {
        return $this->container['individual_owners_and_principals'];
    }

    /**
     * Sets individual_owners_and_principals
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IndividualOwnersAndPrincipalsResult[] $individual_owners_and_principals Identifies a list of any known owners or principals at the business
     *
     * @return $this
     */
    public function setIndividualOwnersAndPrincipals($individual_owners_and_principals)
    {
        $this->container['individual_owners_and_principals'] = $individual_owners_and_principals;

        return $this;
    }

    /**
     * Gets company_owners_and_principals
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\CompanyOwnersAndPrincipalsResult[]
     */
    public function getCompanyOwnersAndPrincipals()
    {
        return $this->container['company_owners_and_principals'];
    }

    /**
     * Sets company_owners_and_principals
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\CompanyOwnersAndPrincipalsResult[] $company_owners_and_principals Identifies any known company owners of the business
     *
     * @return $this
     */
    public function setCompanyOwnersAndPrincipals($company_owners_and_principals)
    {
        $this->container['company_owners_and_principals'] = $company_owners_and_principals;

        return $this;
    }

    /**
     * Gets contacts_and_titles
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ContactsAndTitlesResult[]
     */
    public function getContactsAndTitles()
    {
        return $this->container['contacts_and_titles'];
    }

    /**
     * Sets contacts_and_titles
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ContactsAndTitlesResult[] $contacts_and_titles Contains a list of Business Contacts and their Titles
     *
     * @return $this
     */
    public function setContactsAndTitles($contacts_and_titles)
    {
        $this->container['contacts_and_titles'] = $contacts_and_titles;

        return $this;
    }

    /**
     * Gets contacts_business_affiliations
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\ContactsBusinessAffiliationsResult[]
     */
    public function getContactsBusinessAffiliations()
    {
        return $this->container['contacts_business_affiliations'];
    }

    /**
     * Sets contacts_business_affiliations
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\ContactsBusinessAffiliationsResult[] $contacts_business_affiliations Indicates any business affiliations of the contacts at the business
     *
     * @return $this
     */
    public function setContactsBusinessAffiliations($contacts_business_affiliations)
    {
        $this->container['contacts_business_affiliations'] = $contacts_business_affiliations;
