 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ScoreTrends implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'scoreTrends';
    ...
    protected static $setters = [
        'quarter' => 'setQuarter',
        'score' => 'setScore',
        'industry_score' => 'setIndustryScore'
    ];
    ...
    protected static $getters = [
        'quarter' => 'getQuarter',
        'score' => 'getScore',
        'industry_score' => 'getIndustryScore'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['industry_score'] = isset($data['industry_score']) ? $data['industry_score'] : null;
    }
     ...
     * @return float
     */
    public function getIndustryScore()
    {
        return $this->container['industry_score'];
    }

    /**
     * Sets industry_score
     *
     * @param float $industry_score Benchmark score for the business's industry
     *
     * @return $this
     */
    public function setIndustryScore($industry_score)
    {
        $this->container['industry_score'] = $industry_score;
