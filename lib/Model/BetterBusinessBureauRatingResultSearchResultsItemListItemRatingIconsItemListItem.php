...
/**
 * BetterBusinessBureauRatingResultSearchResultsItemListItemRatingIconsItemListItem Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BetterBusinessBureauRatingResultSearchResultsItemListItemRatingIconsItemListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BetterBusinessBureauRatingResult_searchResults_itemList_item_ratingIcons_itemList_item';
     ...
     * Sets url
     *
     * @param string $url URL for ratings Icon
     *
     * @return $this
     */
