...
/**
 * BusinessContactsResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessContactsResponse extends BusinessDataResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessContactsResponse';
    ...
    protected static $swaggerTypes = [
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\BusinessContactsResult'
    ];
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\BusinessContactsResult $results results
     *
     * @return $this
     */
