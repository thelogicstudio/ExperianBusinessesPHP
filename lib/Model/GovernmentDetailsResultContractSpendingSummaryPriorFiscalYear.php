...
/**
 * GovernmentDetailsResultContractSpendingSummaryPriorFiscalYear Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResultContractSpendingSummaryPriorFiscalYear implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult_contractSpendingSummary_priorFiscalYear';
     ...
     * Sets year
     *
     * @param float $year Prior fiscal year
     *
     * @return $this
     */
     ...
     * Sets total_amount
     *
     * @param float $total_amount Prior fiscal year total dollar amount
     *
     * @return $this
     */
     ...
     *
     * @param float $single_highest_amount Prior fiscal year single highest dollar amount
     *
     * @return $this
     */
