...
/**
 * ClientOfCollectionAgency Class Doc Comment
 *
 * @category Class
 * @description clientOfCollectionAgency
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ClientOfCollectionAgency implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'clientOfCollectionAgency';
    ...
    protected static $setters = [
        ...
        'client_account_number' => 'setClientAccountNumber',
    ...
    protected static $getters = [
        ...
        'client_account_number' => 'getClientAccountNumber',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['client_account_number'] = isset($data['client_account_number']) ? $data['client_account_number'] : null;
    ...
    /**
     * Gets client_account_number
     *
     * @return string
     */
    public function getClientAccountNumber()
    {
        return $this->container['client_account_number'];
    }

    /**
     * Sets client_account_number
     *
     * @param string $client_account_number clientAccountNumber
     *
     * @return $this
     */
    public function setClientAccountNumber($client_account_number)
    {
        $this->container['client_account_number'] = $client_account_number;
     ...
     * Sets contact_name
     *
     * @param string $contact_name contactName
     *
     * @return $this
     */
