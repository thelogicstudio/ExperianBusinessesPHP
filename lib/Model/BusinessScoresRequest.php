...
/**
 * BusinessScoresRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessScoresRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessScoresRequest';
     ...
     * Sets fsr_score
     *
     * @param bool $fsr_score If true, receive the commercial score that has been configured for your subcode
     *
     * @return $this
     */
     ...
     *
     * @param bool $commercial_score If true, receive the Financial Stability Risk score
     *
     * @return $this
     */
