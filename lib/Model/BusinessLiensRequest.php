...
/**
 * BusinessLiensRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessLiensRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessLiensRequest';
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '701000078';
        $this->container['subcode'] = isset($data['subcode']) ? $data['subcode'] : '0586548';
        $this->container['lien_summary'] = isset($data['lien_summary']) ? $data['lien_summary'] : true;
        $this->container['lien_detail'] = isset($data['lien_detail']) ? $data['lien_detail'] : true;
    }
     ...
     * Sets lien_summary
     *
     * @param bool $lien_summary If true receive object containing lien summary information
     *
     * @return $this
     */
     ...
     * Sets lien_detail
     *
     * @param bool $lien_detail If true receive object containing lien detail information
     *
     * @return $this
     */
