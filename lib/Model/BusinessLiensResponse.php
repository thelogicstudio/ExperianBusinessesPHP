...
/**
 * BusinessLiensResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessLiensResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessLiensResponse';
    ...
    protected static $swaggerTypes = [
        'request_id' => 'string',
        'success' => 'bool',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\BusinessLiensResult'
    ];
     ...
     * Sets success
     *
     * @param bool $success If true indicates a successful response status
     *
     * @return $this
     */
     ...
     * Gets results
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\BusinessLiensResult
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\BusinessLiensResult $results results
     *
     * @return $this
     */
