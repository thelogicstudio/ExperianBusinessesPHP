...
/**
 * CorporateLinkageResponseResults Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CorporateLinkageResponseResults implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CorporateLinkageResponse_results';
     ...
     *
     * @param bool $corporate_linkage_indicator If true indicates that corporate linkage is available for the business, if false indicates that corporate linkage is not available
     *
     * @return $this
     */
