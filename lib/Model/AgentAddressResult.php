...
/**
 * AgentAddressResult Class Doc Comment
 *
 * @category Class
 * @description Address information of the registered agent for the corporate registration filing
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AgentAddressResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AgentAddressResult';
    ...
    public function setStreet($street)
    {
        if (!is_null($street) && (mb_strlen($street) > 40)) {
            throw new \InvalidArgumentException('invalid length for $street when calling AgentAddressResult., must be smaller than or equal to 40.');
        }
    ...
    public function setCity($city)
    {
        if (!is_null($city) && (mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling AgentAddressResult., must be smaller than or equal to 30.');
        }
    ...
    public function setState($state)
    {
        if (!is_null($state) && (mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling AgentAddressResult., must be smaller than or equal to 2.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling AgentAddressResult., must be smaller than or equal to 5.');
        }
