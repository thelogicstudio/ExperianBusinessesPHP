...
/**
 * MultiSegmentsResultTradePaymentTrends Class Doc Comment
 *
 * @category Class
 * @description Object containing monthlyTrends and quarterlyTrends
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiSegmentsResultTradePaymentTrends implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiSegmentsResult_tradePaymentTrends';
    ...
    protected static $swaggerTypes = [
        'monthly_trends' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[]',
        'quarterly_trends' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[]'
    ];
    ...
    protected static $setters = [
        'monthly_trends' => 'setMonthlyTrends',
        'quarterly_trends' => 'setQuarterlyTrends'
    ];
    ...
    protected static $getters = [
        'monthly_trends' => 'getMonthlyTrends',
        'quarterly_trends' => 'getQuarterlyTrends'
    ];
    ...
    {
        $this->container['monthly_trends'] = isset($data['monthly_trends']) ? $data['monthly_trends'] : null;
        $this->container['quarterly_trends'] = isset($data['quarterly_trends']) ? $data['quarterly_trends'] : null;
    }
    ...
    {
        return $this->container['monthly_trends'];
    }

    /**
     * Sets monthly_trends
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[] $monthly_trends Snapshot of key performance metrics and trade balances for the last 6 months; current and 6 previous
     *
     * @return $this
     */
    public function setMonthlyTrends($monthly_trends)
    {
        $this->container['monthly_trends'] = $monthly_trends;

        return $this;
    }

    /**
     * Gets quarterly_trends
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[]
     */
    public function getQuarterlyTrends()
    {
        return $this->container['quarterly_trends'];
    }

    /**
     * Sets quarterly_trends
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradePaymentTrend[] $quarterly_trends Snapshot of key performance metrics and trade balance for the last 5 quarters; current and 4 previous
     *
     * @return $this
     */
    public function setQuarterlyTrends($quarterly_trends)
    {
        $this->container['quarterly_trends'] = $quarterly_trends;
