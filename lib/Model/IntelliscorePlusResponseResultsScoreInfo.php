...
/**
 * IntelliscorePlusResponseResultsScoreInfo Class Doc Comment
 *
 * @category Class
 * @description Score nformation:
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsScoreInfo implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_scoreInfo';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['score_sign'] = isset($data['score_sign']) ? $data['score_sign'] : null;
    }
     ...
     * @return string
     */
    public function getScoreSign()
    {
        return $this->container['score_sign'];
    }

    /**
     * Sets score_sign
     *
     * @param string $score_sign Score Sign
     *
     * @return $this
     */
    public function setScoreSign($score_sign)
    {
        $this->container['score_sign'] = $score_sign;
