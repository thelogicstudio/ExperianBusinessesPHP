...
/**
 * MultiSegmentsResultCommercialScoreRiskClass Class Doc Comment
 *
 * @category Class
 * @description Commercial score risk class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MultiSegmentsResultCommercialScoreRiskClass implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MultiSegmentsResult_commercialScore_riskClass';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 50)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 50.";
        }
     ...
     * Sets code
     *
     * @param float $code 1 = \"Low Risk\", 2 = \"Low to Medium Risk\", 3 = \"Medium Risk\", 4 = \"Medium to High Risk\", 5 = \"High Risk\", 998 = \"Recent bankruptcy on file\", 999 = \"Insufficient data to score\"
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Commercial score risk class default values \"High Risk\", \"Medium to High Risk\", \"Medium Risk\", \"Low to Medium Risk\", \"Low Risk\", \"Recent Bankruptcy on file\", \"Insufficient data to score\",
     *
     * @return $this
     */
    public function setDefinition($definition)
    {
        if (!is_null($definition) && (mb_strlen($definition) > 50)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling MultiSegmentsResultCommercialScoreRiskClass., must be smaller than or equal to 50.');
        }
