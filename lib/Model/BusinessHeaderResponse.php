...
/**
 * BusinessHeaderResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessHeaderResponse implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessHeaderResponse';
    ...
    protected static $swaggerTypes = [
        'request_id' => 'string',
        'success' => 'bool',
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\BusinessHeaderResult'
    ];
     ...
     * Sets success
     *
     * @param bool $success Response status (ex. success)
     *
     * @return $this
     */
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\BusinessHeaderResult $results results
     *
     * @return $this
     */
