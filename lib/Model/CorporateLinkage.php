...
/**
 * CorporateLinkage Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CorporateLinkage implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CorporateLinkage';
     ...
     *
     * @param bool $matching_business_indicator Indicates if the matched business is the primary business at that address or not
     *
     * @return $this
     */
     ...
     *
     * @param bool $return_limit_exceeded If true additional records are available to request using the Corporate Linkage API, corporateLinkageFull
     *
     * @return $this
     */
     ...
     * Sets type
     *
     * @param string $type \"Ultimate Parent\", \"Headquarters/Parent\", \"Subsidiary\", or \"Branch\". The Ultimate Parent is the topmost responsible member of the family tree. Parent refers to a business with a subsidiary; the immediate parent is the parent company for the business that is the subject of your request. Subsidiary listings are those which the business in your request has at least a 50% ownership stake. Branch refers to additional locations or alternate addresses for the business in your request.
     *
     * @return $this
     */
