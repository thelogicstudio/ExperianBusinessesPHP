...
/**
 * TradePaymentExperiencesResultRecentHighCredit Class Doc Comment
 *
 * @category Class
 * @description Highest account balance in the last 12 months
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentExperiencesResultRecentHighCredit implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentExperiencesResult_recentHighCredit';
     ...
     * Sets modifier
     *
     * @param string $modifier \"+\" = More than amount reported. \"-\" = Negative amount. \"<\" = Less than amount reported. \"Null\" if Not applicable
     *
     * @return $this
     */
     ...
     * Sets amount
     *
     * @param float $amount Recent high credit amount
     *
     * @return $this
     */
