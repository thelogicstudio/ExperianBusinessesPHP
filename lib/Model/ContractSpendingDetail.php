...
/**
 * ContractSpendingDetail Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ContractSpendingDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'contractSpendingDetail';
     ...
     *
     * @param string $contract_action The type of contract
     *
     * @return $this
     */
     ...
     * Sets contract_id
     *
     * @param string $contract_id Contract ID; IDVPIID, PIID, MOD
     *
     * @return $this
     */
     ...
     * Sets program_source
     *
     * @param string $program_source Program source
     *
     * @return $this
     */
     ...
     *
     * @param string $department_agency Department Agency
     *
     * @return $this
     */
     ...
     *
     * @param string $product_service Product or service ordered in the contract
     *
     * @return $this
     */
     ...
     * Sets signed_date
     *
     * @param string $signed_date Signed Date. YYYY-MM-DD
     *
     * @return $this
     */
     ...
     *
     * @param float $obligation_amount Contract amount
     *
     * @return $this
     */
     ...
     *
     * @param string $additional_description Additional description
     *
     * @return $this
     */
     ...
     *
     * @param float $sequence_number Contract detail sequence number
     *
     * @return $this
     */
