...
class SearchRequest implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['street']) && (mb_strlen($this->container['street']) > 30)) {
            $invalidProperties[] = "invalid value for 'street', the character length must be smaller than or equal to 30.";
        }

        if (!is_null($this->container['zip']) && (mb_strlen($this->container['zip']) > 5)) {
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 40)) {
            throw new \InvalidArgumentException('invalid length for $name when calling SearchRequest., must be smaller than or equal to 40.');
        }
    ...
    public function setCity($city)
    {
        if ((mb_strlen($city) > 30)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SearchRequest., must be smaller than or equal to 30.');
        }
    ...
    public function setState($state)
    {
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling SearchRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling SearchRequest., must be bigger than or equal to 2.');
        }
    ...
    public function setSubcode($subcode)
    {
        if ((mb_strlen($subcode) > 7)) {
            throw new \InvalidArgumentException('invalid length for $subcode when calling SearchRequest., must be smaller than or equal to 7.');
        }
    ...
    {
        if (!is_null($street) && (mb_strlen($street) > 30)) {
            throw new \InvalidArgumentException('invalid length for $street when calling SearchRequest., must be smaller than or equal to 30.');
        }
    ...
    public function setZip($zip)
    {
        if (!is_null($zip) && (mb_strlen($zip) > 5)) {
            throw new \InvalidArgumentException('invalid length for $zip when calling SearchRequest., must be smaller than or equal to 5.');
        }
    ...
    public function setPhone($phone)
    {
        if (!is_null($phone) && (mb_strlen($phone) > 10)) {
            throw new \InvalidArgumentException('invalid length for $phone when calling SearchRequest., must be smaller than or equal to 10.');
        }
    ...
    public function setTaxId($tax_id)
    {
        if (!is_null($tax_id) && (mb_strlen($tax_id) > 9)) {
            throw new \InvalidArgumentException('invalid length for $tax_id when calling SearchRequest., must be smaller than or equal to 9.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 30)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling SearchRequest., must be smaller than or equal to 30.');
        }
