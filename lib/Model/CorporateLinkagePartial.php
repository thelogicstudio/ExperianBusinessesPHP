...
/**
 * CorporateLinkagePartial Class Doc Comment
 *
 * @category Class
 * @description Each Corporate Linkage Partial Information
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CorporateLinkagePartial implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CorporateLinkagePartial';
    ...
    protected static $swaggerTypes = [
        ...
        'matching_business_indicator' => 'bool',
        'return_limit_exceeded' => 'bool'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'business_name' => null,
        'address' => null,
        'matching_business_indicator' => null,
        'return_limit_exceeded' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'address' => 'address',
        'matching_business_indicator' => 'matchingBusinessIndicator',
        'return_limit_exceeded' => 'returnLimitExceeded'
    ];
    ...
    protected static $setters = [
        ...
        'address' => 'setAddress',
        'matching_business_indicator' => 'setMatchingBusinessIndicator',
        'return_limit_exceeded' => 'setReturnLimitExceeded'
    ];
    ...
    protected static $getters = [
        ...
        'address' => 'getAddress',
        'matching_business_indicator' => 'getMatchingBusinessIndicator',
        'return_limit_exceeded' => 'getReturnLimitExceeded'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['matching_business_indicator'] = isset($data['matching_business_indicator']) ? $data['matching_business_indicator'] : null;
        $this->container['return_limit_exceeded'] = isset($data['return_limit_exceeded']) ? $data['return_limit_exceeded'] : null;
    }
    ...
    public function setCorporateLinkageType($corporate_linkage_type)
    {
        if (!is_null($corporate_linkage_type) && (mb_strlen($corporate_linkage_type) > 30)) {
            throw new \InvalidArgumentException('invalid length for $corporate_linkage_type when calling CorporateLinkagePartial., must be smaller than or equal to 30.');
        }
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling CorporateLinkagePartial., must be smaller than or equal to 9.');
        }
    ...
    public function setBusinessName($business_name)
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 120)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling CorporateLinkagePartial., must be smaller than or equal to 120.');
        }
    ...
    /**
     * Gets matching_business_indicator
     *
     * @return bool
     */
    public function getMatchingBusinessIndicator()
    {
        return $this->container['matching_business_indicator'];
    }

    /**
     * Sets matching_business_indicator
     *
     * @param bool $matching_business_indicator If true the linkage business matches the business in your request
     *
     * @return $this
     */
    public function setMatchingBusinessIndicator($matching_business_indicator)
    {
        $this->container['matching_business_indicator'] = $matching_business_indicator;

        return $this;
    }

    /**
     * Gets return_limit_exceeded
     *
     * @return bool
     */
    public function getReturnLimitExceeded()
    {
        return $this->container['return_limit_exceeded'];
    }

    /**
     * Sets return_limit_exceeded
     *
     * @param bool $return_limit_exceeded If true additional records are available to request using corporateLinkageFull
     *
     * @return $this
     */
    public function setReturnLimitExceeded($return_limit_exceeded)
    {
        $this->container['return_limit_exceeded'] = $return_limit_exceeded;
