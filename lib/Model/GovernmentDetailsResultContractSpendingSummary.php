...
/**
 * GovernmentDetailsResultContractSpendingSummary Class Doc Comment
 *
 * @category Class
 * @description Summary of US Government Contract Spending awarded to the business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResultContractSpendingSummary implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult_contractSpendingSummary';
    ...
    protected static $swaggerTypes = [
        ...
        'total_number_of_transactions' => 'float',
        'current_fiscal_year' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryCurrentFiscalYear',
        'prior_fiscal_year' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryPriorFiscalYear[]'
    ];
    ...
    protected static $attributeMap = [
        ...
        'prior_fiscal_year' => 'priorFiscalYear'
    ];
    ...
    protected static $setters = [
        'total_dollar_amount' => 'setTotalDollarAmount',
        'total_number_of_transactions' => 'setTotalNumberOfTransactions',
        'current_fiscal_year' => 'setCurrentFiscalYear',
        'prior_fiscal_year' => 'setPriorFiscalYear'
    ];
    ...
    {
        $this->container['total_dollar_amount'] = isset($data['total_dollar_amount']) ? $data['total_dollar_amount'] : null;
        $this->container['total_number_of_transactions'] = isset($data['total_number_of_transactions']) ? $data['total_number_of_transactions'] : null;
        $this->container['current_fiscal_year'] = isset($data['current_fiscal_year']) ? $data['current_fiscal_year'] : null;
        $this->container['prior_fiscal_year'] = isset($data['prior_fiscal_year']) ? $data['prior_fiscal_year'] : null;
    }
    ...
    /**
     * Gets total_dollar_amount
     *
     * @return float
     */
    public function getTotalDollarAmount()
    {
        return $this->container['total_dollar_amount'];
    }

    /**
     * Sets total_dollar_amount
     *
     * @param float $total_dollar_amount Total dollar amount
     *
     * @return $this
     */
    public function setTotalDollarAmount($total_dollar_amount)
    {
        $this->container['total_dollar_amount'] = $total_dollar_amount;
     ...
     *
     * @param float $total_number_of_transactions Total number of transactions
     *
     * @return $this
     */
    ...
    /**
     * Gets current_fiscal_year
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryCurrentFiscalYear
     */
    public function getCurrentFiscalYear()
    {
        return $this->container['current_fiscal_year'];
    }

    /**
     * Sets current_fiscal_year
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryCurrentFiscalYear $current_fiscal_year current_fiscal_year
     *
     * @return $this
     */
    public function setCurrentFiscalYear($current_fiscal_year)
    {
        $this->container['current_fiscal_year'] = $current_fiscal_year;

        return $this;
    }

    /**
     * Gets prior_fiscal_year
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryPriorFiscalYear[]
     */
    public function getPriorFiscalYear()
    {
        return $this->container['prior_fiscal_year'];
    }

    /**
     * Sets prior_fiscal_year
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummaryPriorFiscalYear[] $prior_fiscal_year Prior fiscal year, occurs up to 4 times
     *
     * @return $this
     */
    public function setPriorFiscalYear($prior_fiscal_year)
    {
        $this->container['prior_fiscal_year'] = $prior_fiscal_year;
