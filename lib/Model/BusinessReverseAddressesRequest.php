...
/**
 * BusinessReverseAddressesRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessReverseAddressesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessReverseAddressesRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['street'] = isset($data['street']) ? $data['street'] : '1 Infinite Loop';
        $this->container['city'] = isset($data['city']) ? $data['city'] : 'Cupertino';
        $this->container['state'] = isset($data['state']) ? $data['state'] : 'CA';
        $this->container['zip'] = isset($data['zip']) ? $data['zip'] : '10118';
    }
    ...
    public function setState($state)
    {
        if ((mb_strlen($state) > 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BusinessReverseAddressesRequest., must be smaller than or equal to 2.');
        }
        if ((mb_strlen($state) < 2)) {
            throw new \InvalidArgumentException('invalid length for $state when calling BusinessReverseAddressesRequest., must be bigger than or equal to 2.');
        }
