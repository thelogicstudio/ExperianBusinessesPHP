...
/**
 * ReversePhones Class Doc Comment
 *
 * @category Class
 * @description Details of Reverse Phones
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReversePhones implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ReversePhones';
     ...
     *
     * @param float $sequence_number Reverse Tax ID matches are ordered by BINs that were updated most recently (binDateLastReported)
     *
     * @return $this
     */
    ...
    public function setBin($bin)
    {
        if (!is_null($bin) && (mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling ReversePhones., must be smaller than or equal to 9.');
        }
    ...
    public function setBusinessName($business_name)
    {
        if (!is_null($business_name) && (mb_strlen($business_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $business_name when calling ReversePhones., must be smaller than or equal to 255.');
        }
    ...
    public function setBinEstablishDate($bin_establish_date)
    {
        if (!is_null($bin_establish_date) && (mb_strlen($bin_establish_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bin_establish_date when calling ReversePhones., must be smaller than or equal to 10.');
        }
    ...
    public function setBinDateLastReported($bin_date_last_reported)
    {
        if (!is_null($bin_date_last_reported) && (mb_strlen($bin_date_last_reported) > 10)) {
            throw new \InvalidArgumentException('invalid length for $bin_date_last_reported when calling ReversePhones., must be smaller than or equal to 10.');
        }
