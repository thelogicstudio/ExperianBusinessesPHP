...
/**
 * BusinessCollectionsSummaryResult Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessCollectionsSummaryResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessCollectionsSummaryResult';
     ...
     *
     * @param float $collection_count Count of total collection filings
     *
     * @return $this
     */
     ...
     *
     * @param float $collection_balance Total outstanding collections balance
     *
     * @return $this
     */
