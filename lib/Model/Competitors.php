 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Competitors implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'competitors';
    ...
    protected static $setters = [
        ...
        'competitor_bin' => 'setCompetitorBin'
    ];
    ...
    protected static $getters = [
        ...
        'competitor_bin' => 'getCompetitorBin'
    ];
    ...
    {
        $this->container['competitor_name'] = isset($data['competitor_name']) ? $data['competitor_name'] : null;
        $this->container['competitor_bin'] = isset($data['competitor_bin']) ? $data['competitor_bin'] : null;
    }
     ...
     *
     * @param string $competitor_name Name of a primary competitor of the business
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getCompetitorBin()
    {
        return $this->container['competitor_bin'];
    }

    /**
     * Sets competitor_bin
     *
     * @param string $competitor_bin Business Identification Number (BIN) of the competitor
     *
     * @return $this
     */
    public function setCompetitorBin($competitor_bin)
    {
        $this->container['competitor_bin'] = $competitor_bin;
