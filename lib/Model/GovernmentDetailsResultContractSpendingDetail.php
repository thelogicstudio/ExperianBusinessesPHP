...
/**
 * GovernmentDetailsResultContractSpendingDetail Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResultContractSpendingDetail implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult_contractSpendingDetail';
    ...
    protected static $setters = [
        'contract_action' => 'setContractAction',
        'program_source' => 'setProgramSource',
        'department_agency' => 'setDepartmentAgency',
        'product_service' => 'setProductService',
        'signed_date' => 'setSignedDate',
        'obligation_amount' => 'setObligationAmount',
        'reason_for_modification' => 'setReasonForModification',
    ...
    protected static $getters = [
        'contract_action' => 'getContractAction',
        'program_source' => 'getProgramSource',
        'department_agency' => 'getDepartmentAgency',
        'product_service' => 'getProductService',
        'signed_date' => 'getSignedDate',
        'obligation_amount' => 'getObligationAmount',
        'reason_for_modification' => 'getReasonForModification',
    ...
    {
        $this->container['contract_action'] = isset($data['contract_action']) ? $data['contract_action'] : null;
        $this->container['program_source'] = isset($data['program_source']) ? $data['program_source'] : null;
        $this->container['department_agency'] = isset($data['department_agency']) ? $data['department_agency'] : null;
        $this->container['product_service'] = isset($data['product_service']) ? $data['product_service'] : null;
        $this->container['signed_date'] = isset($data['signed_date']) ? $data['signed_date'] : null;
        $this->container['obligation_amount'] = isset($data['obligation_amount']) ? $data['obligation_amount'] : null;
        $this->container['reason_for_modification'] = isset($data['reason_for_modification']) ? $data['reason_for_modification'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['signed_date']) && (mb_strlen($this->container['signed_date']) > 10)) {
            $invalidProperties[] = "invalid value for 'signed_date', the character length must be smaller than or equal to 10.";
        }
    ...
    /**
     * Gets contract_action
     *
     * @return string
     */
    public function getContractAction()
    {
        return $this->container['contract_action'];
    }

    /**
     * Sets contract_action
     *
     * @param string $contract_action Contract Action description
     *
     * @return $this
     */
    public function setContractAction($contract_action)
    {
        $this->container['contract_action'] = $contract_action;
    ...
    {
        return $this->container['program_source'];
    }

    /**
     * Sets program_source
     *
     * @param string $program_source Program Source description. Null if not reported
     *
     * @return $this
     */
    public function setProgramSource($program_source)
    {
        $this->container['program_source'] = $program_source;

        return $this;
    }

    /**
     * Gets department_agency
     *
     * @return string
     */
    public function getDepartmentAgency()
    {
        return $this->container['department_agency'];
    }

    /**
     * Sets department_agency
     *
     * @param string $department_agency Department Agency description. Null if not reported
     *
     * @return $this
     */
    public function setDepartmentAgency($department_agency)
    {
        $this->container['department_agency'] = $department_agency;

        return $this;
    }

    /**
     * Gets product_service
     *
     * @return string
     */
    public function getProductService()
    {
        return $this->container['product_service'];
    }

    /**
     * Sets product_service
     *
     * @param string $product_service Product Service description. Null if not reported
     *
     * @return $this
     */
    public function setProductService($product_service)
    {
        $this->container['product_service'] = $product_service;
     ...
     * Sets signed_date
     *
     * @param string $signed_date Date contract was signed. Format YYYY-MM-DD
     *
     * @return $this
     */
    public function setSignedDate($signed_date)
    {
        if (!is_null($signed_date) && (mb_strlen($signed_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $signed_date when calling GovernmentDetailsResultContractSpendingDetail., must be smaller than or equal to 10.');
        }
    ...
    /**
     * Gets obligation_amount
     *
     * @return float
     */
    public function getObligationAmount()
    {
        return $this->container['obligation_amount'];
    }

    /**
     * Sets obligation_amount
     *
     * @param float $obligation_amount Dollar amount of obligation
     *
     * @return $this
     */
    public function setObligationAmount($obligation_amount)
    {
        $this->container['obligation_amount'] = $obligation_amount;

        return $this;
    }

    /**
     * Gets reason_for_modification
     *
     * @return string
     */
    public function getReasonForModification()
    {
        return $this->container['reason_for_modification'];
    }

    /**
     * Sets reason_for_modification
     *
     * @param string $reason_for_modification Reason for modification
     *
     * @return $this
     */
    public function setReasonForModification($reason_for_modification)
    {
        $this->container['reason_for_modification'] = $reason_for_modification;
     ...
     *
     * @param float $sequence_number This field shall be assigned a number (01-05) depending on which contractSpendingDetail segment has been generated. This value shall be used to match the appropriate contractAdditionalDescription segment to its appropriate 5620 segment
     *
     * @return $this
     */
