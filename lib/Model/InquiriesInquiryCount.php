...
/**
 * InquiriesInquiryCount Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InquiriesInquiryCount implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'inquiries_inquiryCount';
     ...
     * Sets count
     *
     * @param float $count Inquiry count
     *
     * @return $this
     */
