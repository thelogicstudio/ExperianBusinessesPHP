...
/**
 * BusinessCorporateLinkageRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessCorporateLinkageRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessCorporateLinkageRequest';
    ...
    protected static $swaggerTypes = [
        ...
        'subcode' => 'string',
        'model_code' => 'string',
        'corporate_linkage_partial' => 'bool',
        'corporate_linkage_full' => 'bool'
    ];
    ...
    {
        $this->container['bin'] = isset($data['bin']) ? $data['bin'] : '700513485';
        ...
        $this->container['corporate_linkage_partial'] = isset($data['corporate_linkage_partial']) ? $data['corporate_linkage_partial'] : true;
        $this->container['corporate_linkage_full'] = isset($data['corporate_linkage_full']) ? $data['corporate_linkage_full'] : true;
    }
     ...
     *
     * @param bool $corporate_linkage_partial If true receive a partial corporate family tree. When linkage is present, corporateLinkagePartial will return the Ultimate Parent, the immediate Parent/Headquarters, up to 10 Subsidiaries, and up to 10 branches. If additional data is available, the returnLimitExceeded indicator will be true
     *
     * @return $this
     */
     ...
     *
     * @param bool $corporate_linkage_full If true receive the full corporate family tree. When linkage is present, corporateLinkageFull will return the full family tree, limited to 300 records. When there are more than 300 records, branches will not be returned (this occurs less than 1% of the time)
     *
     * @return $this
     */
