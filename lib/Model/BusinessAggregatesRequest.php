...
/**
 * BusinessAggregatesRequest Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessAggregatesRequest implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessAggregatesRequest';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['comments'] = isset($data['comments']) ? $data['comments'] : 'test';
    }
    ...
    {
        if ((mb_strlen($bin) > 9)) {
            throw new \InvalidArgumentException('invalid length for $bin when calling BusinessAggregatesRequest., must be smaller than or equal to 9.');
        }
    ...
    public function setSubcode($subcode)
    {
        if ((mb_strlen($subcode) > 7)) {
            throw new \InvalidArgumentException('invalid length for $subcode when calling BusinessAggregatesRequest., must be smaller than or equal to 7.');
        }
    ...
    public function setComments($comments)
    {
        if (!is_null($comments) && (mb_strlen($comments) > 30)) {
            throw new \InvalidArgumentException('invalid length for $comments when calling BusinessAggregatesRequest., must be smaller than or equal to 30.');
        }
