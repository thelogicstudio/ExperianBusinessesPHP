...
/**
 * IntelliscorePlusResponseResultsIntelliscoreFactors Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsIntelliscoreFactors implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_intelliscoreFactors';
    ...
    protected static $swaggerTypes = [
        'score_factor' => '\TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreFactor',
        'model_code' => 'string'
    ];
    ...
    {
        $this->container['score_factor'] = isset($data['score_factor']) ? $data['score_factor'] : null;
     ...
     * Gets score_factor
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreFactor
     */
    public function getScoreFactor()
    {
        return $this->container['score_factor'];
    }

    /**
     * Sets score_factor
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\IntelliscorePlusResponseResultsScoreFactor $score_factor score_factor
     *
     * @return $this
     */
    public function setScoreFactor($score_factor)
    {
        $this->container['score_factor'] = $score_factor;
