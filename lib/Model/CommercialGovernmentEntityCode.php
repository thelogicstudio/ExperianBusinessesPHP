...
/**
 * CommercialGovernmentEntityCode Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommercialGovernmentEntityCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'commercialGovernmentEntityCode';
     ...
     * Sets cage_code
     *
     * @param string $cage_code 5-digit US Department of Defense unique identifier assigned to federal government suppliers, referred to as the Commercial and Government Entity Code
     *
     * @return $this
     */
     ...
     * Sets sam_number
     *
     * @param float $sam_number System for Award Management (SAM) Number
     *
     * @return $this
     */
