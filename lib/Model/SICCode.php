 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SICCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SICCode';
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['definition']) && (mb_strlen($this->container['definition']) > 75)) {
            $invalidProperties[] = "invalid value for 'definition', the character length must be smaller than or equal to 75.";
        }
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 8)) {
            throw new \InvalidArgumentException('invalid length for $code when calling SICCode., must be smaller than or equal to 8.');
        }
    ...
    {
        if (!is_null($definition) && (mb_strlen($definition) > 75)) {
            throw new \InvalidArgumentException('invalid length for $definition when calling SICCode., must be smaller than or equal to 75.');
        }
