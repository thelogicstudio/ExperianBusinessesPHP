...
/**
 * BusinessFraudShieldResponse Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessFraudShieldResponse extends BusinessDataResponse 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessFraudShieldResponse';
    ...
    protected static $swaggerTypes = [
        'results' => '\TheLogicStudio\ExperianBusinessesPHP\Model\BusinessFraudShieldResult'
    ];
     ...
     * Sets results
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\BusinessFraudShieldResult $results results
     *
     * @return $this
     */
