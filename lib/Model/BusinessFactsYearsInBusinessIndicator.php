...
/**
 * BusinessFactsYearsInBusinessIndicator Class Doc Comment
 *
 * @category Class
 * @description Indicator code for how long the company has been in business
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessFactsYearsInBusinessIndicator implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessFacts_yearsInBusinessIndicator';
     ...
     * Sets code
     *
     * @param string $code A = Under 1 year. B = 1 year. C = 2 years. D = 3 to 5 years. E = 6 to 10 years. F = Over 10 years. Blank = Not available
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Years in Business indicator code description
     *
     * @return $this
     */
