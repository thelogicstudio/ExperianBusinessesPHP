...
/**
 * ExecutiveSummaryCurrentTotalAccountBalance Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ExecutiveSummaryCurrentTotalAccountBalance implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'executiveSummary_currentTotalAccountBalance';
     ...
     * Sets amount
     *
     * @param float $amount Current total account balance
     *
     * @return $this
     */
