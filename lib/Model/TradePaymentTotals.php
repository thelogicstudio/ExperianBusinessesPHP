...
/**
 * TradePaymentTotals Class Doc Comment
 *
 * @category Class
 * @description Snapshot of key performance metrics and trade balances
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TradePaymentTotals implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TradePaymentTotals';
    ...
    protected static $swaggerTypes = [
        'tradelines' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine',
        'newly_reported_tradelines' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine',
        'continuously_reported_tradelines' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine',
        'combined_tradelines' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine',
        'additional_tradelines' => '\TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine'
    ];
    ...
    protected static $swaggerFormats = [
        'tradelines' => null,
        'newly_reported_tradelines' => null,
        'continuously_reported_tradelines' => null,
        'combined_tradelines' => null,
        'additional_tradelines' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'newly_reported_tradelines' => 'newlyReportedTradelines',
        'continuously_reported_tradelines' => 'continuouslyReportedTradelines',
        'combined_tradelines' => 'combinedTradelines',
        'additional_tradelines' => 'additionalTradelines'
    ];
    ...
    protected static $setters = [
        'tradelines' => 'setTradelines',
        'newly_reported_tradelines' => 'setNewlyReportedTradelines',
        'continuously_reported_tradelines' => 'setContinuouslyReportedTradelines',
        'combined_tradelines' => 'setCombinedTradelines',
        'additional_tradelines' => 'setAdditionalTradelines'
    ];
    ...
    protected static $getters = [
        'tradelines' => 'getTradelines',
        'newly_reported_tradelines' => 'getNewlyReportedTradelines',
        'continuously_reported_tradelines' => 'getContinuouslyReportedTradelines',
        'combined_tradelines' => 'getCombinedTradelines',
        'additional_tradelines' => 'getAdditionalTradelines'
    ];
    ...
    {
        $this->container['tradelines'] = isset($data['tradelines']) ? $data['tradelines'] : null;
        $this->container['newly_reported_tradelines'] = isset($data['newly_reported_tradelines']) ? $data['newly_reported_tradelines'] : null;
        $this->container['continuously_reported_tradelines'] = isset($data['continuously_reported_tradelines']) ? $data['continuously_reported_tradelines'] : null;
        $this->container['combined_tradelines'] = isset($data['combined_tradelines']) ? $data['combined_tradelines'] : null;
        $this->container['additional_tradelines'] = isset($data['additional_tradelines']) ? $data['additional_tradelines'] : null;
    }
     ...
     * Gets tradelines
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine
     */
    public function getTradelines()
    {
        return $this->container['tradelines'];
    }

    /**
     * Sets tradelines
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine $tradelines tradelines
     *
     * @return $this
     */
    public function setTradelines($tradelines)
    {
        $this->container['tradelines'] = $tradelines;

        return $this;
    }

    /**
     * Gets newly_reported_tradelines
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine
     */
    public function getNewlyReportedTradelines()
    {
        return $this->container['newly_reported_tradelines'];
    }

    /**
     * Sets newly_reported_tradelines
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine $newly_reported_tradelines newly_reported_tradelines
     *
     * @return $this
     */
    public function setNewlyReportedTradelines($newly_reported_tradelines)
    {
        $this->container['newly_reported_tradelines'] = $newly_reported_tradelines;

        return $this;
    }

    /**
     * Gets continuously_reported_tradelines
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine
     */
    public function getContinuouslyReportedTradelines()
    {
        return $this->container['continuously_reported_tradelines'];
    }

    /**
     * Sets continuously_reported_tradelines
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine $continuously_reported_tradelines continuously_reported_tradelines
     *
     * @return $this
     */
    public function setContinuouslyReportedTradelines($continuously_reported_tradelines)
    {
        $this->container['continuously_reported_tradelines'] = $continuously_reported_tradelines;

        return $this;
    }

    /**
     * Gets combined_tradelines
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine
     */
    public function getCombinedTradelines()
    {
        return $this->container['combined_tradelines'];
    }

    /**
     * Sets combined_tradelines
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine $combined_tradelines combined_tradelines
     *
     * @return $this
     */
    public function setCombinedTradelines($combined_tradelines)
    {
        $this->container['combined_tradelines'] = $combined_tradelines;

        return $this;
    }

    /**
     * Gets additional_tradelines
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine
     */
    public function getAdditionalTradelines()
    {
        return $this->container['additional_tradelines'];
    }

    /**
     * Sets additional_tradelines
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\TradeLine $additional_tradelines additional_tradelines
     *
     * @return $this
     */
    public function setAdditionalTradelines($additional_tradelines)
    {
        $this->container['additional_tradelines'] = $additional_tradelines;
