...
/**
 * IntelliscorePlusResponseResultsCustomHeader Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IntelliscorePlusResponseResultsCustomHeader implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IntelliscorePlusResponse_results_customHeader';
     ...
     * Sets code
     *
     * @param string $code Score factor code
     *
     * @return $this
     */
     ...
     * Sets definition
     *
     * @param string $definition Score factor description
     *
     * @return $this
     */
