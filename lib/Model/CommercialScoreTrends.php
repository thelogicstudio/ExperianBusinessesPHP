...
/**
 * CommercialScoreTrends Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CommercialScoreTrends implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CommercialScoreTrends';
    ...
    public function setQuarter($quarter)
    {
        if (!is_null($quarter) && (mb_strlen($quarter) > 7)) {
            throw new \InvalidArgumentException('invalid length for $quarter when calling CommercialScoreTrends., must be smaller than or equal to 7.');
        }
