...
/**
 * BusinessTradesResponseResults Class Doc Comment
 *
 * @category Class
 * @description Business trades information
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BusinessTradesResponseResults implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BusinessTradesResponse_results';
    ...
    protected static $attributeMap = [
        ...
        'trade_indicator' => 'tradeIndicator'
    ];
    ...
    protected static $setters = [
        ...
        'trade_indicator' => 'setTradeIndicator'
    ];
    ...
    protected static $getters = [
        ...
        'trade_indicator' => 'getTradeIndicator'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['trade_indicator'] = isset($data['trade_indicator']) ? $data['trade_indicator'] : null;
    }
    ...
    /**
     * Gets trade_indicator
     *
     * @return bool
     */
    public function getTradeIndicator()
    {
        return $this->container['trade_indicator'];
    }

    /**
     * Sets trade_indicator
     *
     * @param bool $trade_indicator If true indicates that trades are on file for the business, if false indicates that the business does not have any trades on file
     *
     * @return $this
     */
    public function setTradeIndicator($trade_indicator)
    {
        $this->container['trade_indicator'] = $trade_indicator;
