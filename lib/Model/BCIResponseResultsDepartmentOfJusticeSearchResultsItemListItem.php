...
/**
 * BCIResponseResultsDepartmentOfJusticeSearchResultsItemListItem Class Doc Comment
 *
 * @category Class
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BCIResponseResultsDepartmentOfJusticeSearchResultsItemListItem implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BCIResponse_results_departmentOfJusticeSearch_results_itemList_item';
    ...
    protected static $setters = [
        ...
        'snippet' => 'setSnippet',
        'date_last_crawled' => 'setDateLastCrawled'
    ];
    ...
    protected static $getters = [
        ...
        'snippet' => 'getSnippet',
        'date_last_crawled' => 'getDateLastCrawled'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['date_last_crawled'] = isset($data['date_last_crawled']) ? $data['date_last_crawled'] : null;
    }
    ...
    /**
     * Gets date_last_crawled
     *
     * @return string
     */
    public function getDateLastCrawled()
    {
        return $this->container['date_last_crawled'];
    }

    /**
     * Sets date_last_crawled
     *
     * @param string $date_last_crawled date Last Crawled
     *
     * @return $this
     */
    public function setDateLastCrawled($date_last_crawled)
    {
        $this->container['date_last_crawled'] = $date_last_crawled;
