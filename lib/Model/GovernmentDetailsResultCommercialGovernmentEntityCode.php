...
/**
 * GovernmentDetailsResultCommercialGovernmentEntityCode Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResultCommercialGovernmentEntityCode implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult_commercialGovernmentEntityCode';
    ...
    {
        $this->container['cage_code'] = isset($data['cage_code']) ? $data['cage_code'] : null;
        $this->container['sam_number'] = isset($data['sam_number']) ? $data['sam_number'] : null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sam_number']) && (mb_strlen($this->container['sam_number']) > 30)) {
            $invalidProperties[] = "invalid value for 'sam_number', the character length must be smaller than or equal to 30.";
        }
     ...
     * Sets cage_code
     *
     * @param string $cage_code Commercial and Government Entity Code
     *
     * @return $this
     */
     ...
     * @return string
     */
    public function getSamNumber()
    {
        return $this->container['sam_number'];
    }

    /**
     * Sets sam_number
     *
     * @param string $sam_number Service for Award Management Number assigned by the government to suppliers
     *
     * @return $this
     */
    public function setSamNumber($sam_number)
    {
        if (!is_null($sam_number) && (mb_strlen($sam_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $sam_number when calling GovernmentDetailsResultCommercialGovernmentEntityCode., must be smaller than or equal to 30.');
        }

        $this->container['sam_number'] = $sam_number;
