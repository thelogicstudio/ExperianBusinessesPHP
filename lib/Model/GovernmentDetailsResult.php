...
/**
 * GovernmentDetailsResult Class Doc Comment
 *
 * @category Class
 * @description Government Details Result
 * @package  TheLogicStudio\ExperianBusinessesPHP
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GovernmentDetailsResult implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GovernmentDetailsResult';
    ...
    protected static $swaggerTypes = [
        'commercial_government_entity_code' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultCommercialGovernmentEntityCode',
        'economic_diversity' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultEconomicDiversity',
        'government_activity' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultGovernmentActivity',
        'contract_spending_summary' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummary',
        'contract_spending_detail' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingDetail[]',
        'contract_additional_description' => '\TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractAdditionalDescription[]'
    ];
    ...
    protected static $swaggerFormats = [
        ...
        'contract_additional_description' => null
    ];
    ...
    protected static $attributeMap = [
        ...
        'contract_additional_description' => 'contractAdditionalDescription'
    ];
    ...
    protected static $setters = [
        ...
        'contract_additional_description' => 'setContractAdditionalDescription'
    ];
    ...
    protected static $getters = [
        ...
        'contract_additional_description' => 'getContractAdditionalDescription'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['contract_additional_description'] = isset($data['contract_additional_description']) ? $data['contract_additional_description'] : null;
    }
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultCommercialGovernmentEntityCode
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultCommercialGovernmentEntityCode $commercial_government_entity_code commercial_government_entity_code
     *
     * @return $this
     */
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultEconomicDiversity
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultEconomicDiversity $economic_diversity economic_diversity
     *
     * @return $this
     */
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultGovernmentActivity
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultGovernmentActivity $government_activity government_activity
     *
     * @return $this
     */
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummary
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingSummary $contract_spending_summary contract_spending_summary
     *
     * @return $this
     */
     ...
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingDetail[]
     */
     ...
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractSpendingDetail[] $contract_spending_detail Provides up to five years of prime contract transaction data for federal agencies making contract, grant, loan, and other financial assistance awards
     *
     * @return $this
     */
    ...
    /**
     * Gets contract_additional_description
     *
     * @return \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractAdditionalDescription[]
     */
    public function getContractAdditionalDescription()
    {
        return $this->container['contract_additional_description'];
    }

    /**
     * Sets contract_additional_description
     *
     * @param \TheLogicStudio\ExperianBusinessesPHP\Model\GovernmentDetailsResultContractAdditionalDescription[] $contract_additional_description Contract Additional Description
     *
     * @return $this
     */
    public function setContractAdditionalDescription($contract_additional_description)
    {
        $this->container['contract_additional_description'] = $contract_additional_description;
