...
class BusinessInformationServicesApi
{
     ...
     */
    public function bci($body, $content_type = 'application/json')
    {
     ...
     */
    public function bciWithHttpInfo($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bciAsync($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bciAsyncWithHttpInfo($body, $content_type = 'application/json')
    {
        $returnType = '\TheLogicStudio\ExperianBusinessesPHP\Model\BCIResponse';
        $request = $this->bciRequest($body, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bciRequest($body, $content_type = 'application/json')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function bcihtml($body, $content_type = 'application/json')
    {
     ...
     */
    public function bcihtmlWithHttpInfo($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bcihtmlAsync($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bcihtmlAsyncWithHttpInfo($body, $content_type = 'application/json')
    {
        $returnType = '\TheLogicStudio\ExperianBusinessesPHP\Model\BCIResponseHTML';
        $request = $this->bcihtmlRequest($body, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bcihtmlRequest($body, $content_type = 'application/json')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function bcipdf($body, $content_type = 'application/json')
    {
     ...
     */
    public function bcipdfWithHttpInfo($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bcipdfAsync($body, $content_type = 'application/json')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function bcipdfAsyncWithHttpInfo($body, $content_type = 'application/json')
    {
        $returnType = '\TheLogicStudio\ExperianBusinessesPHP\Model\BCIResponsePDF';
        $request = $this->bcipdfRequest($body, $content_type);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function bcipdfRequest($body, $content_type = 'application/json')
    {
        // verify the required parameter 'body' is set
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
